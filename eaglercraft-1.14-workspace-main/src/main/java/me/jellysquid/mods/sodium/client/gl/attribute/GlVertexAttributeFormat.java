...
import static net.lax1dude.eaglercraft.opengl.RealOpenGLEnums.GL_FLOAT;
import static net.lax1dude.eaglercraft.opengl.RealOpenGLEnums.GL_UNSIGNED_BYTE;
import static net.lax1dude.eaglercraft.opengl.RealOpenGLEnums.GL_UNSIGNED_SHORT;
