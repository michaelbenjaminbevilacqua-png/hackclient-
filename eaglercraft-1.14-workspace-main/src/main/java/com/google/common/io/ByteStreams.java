...
public final class ByteStreams {
     ...
     */
    @Deprecated
    public static InputSupplier<EaglerInputStream> newInputStreamSupplier(byte[] b) {
     ...
     */
    @Deprecated
    public static InputSupplier<EaglerInputStream> newInputStreamSupplier(final byte[] b, final int off,
                                                                          final int len) {
    ...
    public static ByteArrayDataInput newDataInput(byte[] bytes) {
        return newDataInput(new EaglerInputStream(bytes));
    }
    ...
    public static ByteArrayDataInput newDataInput(byte[] bytes, int start) {
        ...
        return newDataInput(new EaglerInputStream(bytes, start, bytes.length - start));
    }
    ...
    private static class ByteArrayDataInputStream implements ByteArrayDataInput {
        ...
        ByteArrayDataInputStream(EaglerInputStream byteArrayInputStream) {
