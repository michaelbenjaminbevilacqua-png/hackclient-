...
public final class Queues {
    ...
    // ConcurrentLinkedQueue (replaced with LinkedList for TeaVM)

    /**
     * Creates an empty queue.
     */
    public static <E> LinkedList<E> newConcurrentLinkedQueue() {
        return new LinkedList<>();
    }

    /**
     * Creates a queue containing the elements of the
     * specified iterable, in the order they are returned by the iterable's
     * iterator.
     */
    public static <E> LinkedList<E> newConcurrentLinkedQueue(Iterable<? extends E> elements) {
        if (elements instanceof Collection) {
            return new LinkedList<>((Collection<? extends E>) elements);
        }
     ...
     * @since 28.0
     */
    public static <E> int drain(BlockingQueue<E> q, Collection<? super E> buffer, int numElements, Duration timeout)
