...
public abstract class ImmutableMultiset<E> extends ImmutableCollection<E> implements Multiset<E> {
     ...
     *
     * <p>
     * The multiset is ordered by the first occurrence of each element. For example,
     * {@code ImmutableMultiset.copyOf([2, 3, 1, 3])} yields a multiset with
     ...
     * <p>
     * The multiset is ordered by the first occurrence of each element. For example,
     * {@code ImmutableMultiset.copyOf(Arrays.asList(2, 3, 1, 3))} yields a multiset
     ...
     * {@code ImmutableMultiset}, no copy will actually be performed, and the given
     * multiset itself will be returned.
     *
     * @throws NullPointerException if any of {@code elements} is null
     */
     ...
     * <p>
     * The multiset is ordered by the first occurrence of each element. For example,
     * {@code ImmutableMultiset.copyOf(Arrays.asList(2, 3, 1, 3).iterator())} yields
