...
public final class GsonBuilder {
    private final Map<Class<?>, InstanceCreator<?>> instanceCreators = new HashMap<Class<?>, InstanceCreator<?>>();
    ...
    public GsonBuilder registerTypeAdapter(Class<?> type, Object typeAdapter) {
        ...
        if (typeAdapter instanceof JsonSerializer<?> || typeAdapter instanceof JsonDeserializer<?>) {
            factories.add(TreeTypeAdapter.newFactoryWithMatchRawType(type, typeAdapter));
        }
        if (typeAdapter instanceof TypeAdapter<?>) {
            factories.add(TypeAdapters.newFactory(type, (TypeAdapter) typeAdapter));
        }
        return this;
    }
    ...
    public Gson create() {
        ...
        return new Gson(fieldNamingPolicy, instanceCreators, serializeNulls, complexMapKeySerialization,
    ...
    private void addTypeAdaptersForDate(String datePattern, int dateStyle, int timeStyle,
        ...
        factories.add(TreeTypeAdapter.newFactory(Date.class, dateTypeAdapter));
        //factories.add(TreeTypeAdapter.newFactory(Timestamp.class, dateTypeAdapter));
        //factories.add(TreeTypeAdapter.newFactory(java.sql.Date.class, dateTypeAdapter));
    }
}
