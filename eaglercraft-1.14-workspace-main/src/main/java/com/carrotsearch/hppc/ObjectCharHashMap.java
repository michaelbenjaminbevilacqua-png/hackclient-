...
/**
 * A hash map of <code>Object</code> to <code>char</code>, implemented using
...
public class ObjectCharHashMap<KType> implements ObjectCharMap<KType>, Preallocable, Cloneable, Accountable {
    /**
