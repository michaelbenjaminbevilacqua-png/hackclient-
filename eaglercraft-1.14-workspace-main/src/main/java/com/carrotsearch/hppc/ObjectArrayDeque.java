...
public class ObjectArrayDeque<KType> extends AbstractObjectCollection<KType>
    ...
    /**
     * Create a new deque by pushing a variable number of arguments to the end of
     * it.
     */
    @SafeVarargs
     ...
     *
     * @param index Index of the element to remove. The index must be located
     *              between {@link #head} and {@link #tail} in modulo
     *              {@link #buffer} arithmetic.
     */
    ...
    protected void ensureBufferSpace(int expectedAdditions) {
        ...
        if (elementsCount + expectedAdditions >= bufferLen) {
            ...
            try {
                ...
                throw new BufferAllocationException("Not enough memory to allocate new buffers: %,d -> %,d", e,
                        bufferLen, newSize);
            }
        }
    }
     ...
     * <code>target</code> array is filled from index 0 (head of the queue) to index
     ...
     * primitive types). To read the current value (or index in the deque's buffer)
    ...
    /**
     * Applies <code>procedure</code> to a slice of the deque, <code>toIndex</code>,
     * exclusive, down to <code>fromIndex</code>, inclusive.
     */
    ...
    /**
     * Applies <code>predicate</code> to a slice of the deque, <code>toIndex</code>,
     * exclusive, down to <code>fromIndex</code>, inclusive or until the predicate
    ...
    /**
     * Compare order-aligned elements against another {@link ObjectDeque}. Equality
     * comparison is performed with this object's {@link #equals(Object, Object)}
     * method.
     */
