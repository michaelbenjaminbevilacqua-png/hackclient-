 ...
 * entries to another {@link ShortLongHashMap} as this may result in a runtime
 * deadlock. See
...
public class SortedIterationShortLongHashMap implements ShortLongMap {
     ...
     */
    public SortedIterationShortLongHashMap(ShortLongHashMap delegate, ShortLongComparator comparator) {
        this.delegate = delegate;
        this.iterationOrder = sortIterationOrder(createEntryIndexes(), comparator);
    }
