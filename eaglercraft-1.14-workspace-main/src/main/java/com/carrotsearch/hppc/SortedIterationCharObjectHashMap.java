...
import com.carrotsearch.hppc.comparators.CharObjectComparator;
 ...
 * entries to another {@link CharObjectHashMap} as this may result in a runtime
 * deadlock. See
...
public class SortedIterationCharObjectHashMap<VType> implements CharObjectMap<VType> {
    ...
    private final class KeysContainer extends AbstractCharCollection implements CharLookupContainer {
        private final SortedIterationCharObjectHashMap<VType> owner = SortedIterationCharObjectHashMap.this;
