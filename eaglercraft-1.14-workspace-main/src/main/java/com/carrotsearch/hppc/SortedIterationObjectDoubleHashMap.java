 ...
 * entries to another {@link ObjectDoubleHashMap} as this may result in a
...
public class SortedIterationObjectDoubleHashMap<KType> implements ObjectDoubleMap<KType> {
     ...
     */
    public SortedIterationObjectDoubleHashMap(ObjectDoubleHashMap<KType> delegate,
                                              ObjectDoubleComparator<KType> comparator) {
        this.delegate = delegate;
        this.iterationOrder = sortIterationOrder(createEntryIndexes(), comparator);
    }
    ...
    private final class KeysContainer extends AbstractObjectCollection<KType> implements ObjectLookupContainer<KType> {
        private final SortedIterationObjectDoubleHashMap<KType> owner = SortedIterationObjectDoubleHashMap.this;
