 ...
 *
 * <p>
 * The sorting is not stable. Performance is O(n.log(n)) and memory is O(1)
 * (although recursion memory is O(log(n))).
 */
public final class QuickSort {
    ...
    public static void sort(int[] array, int fromIndex, int toIndex, IntBinaryOperator comparator) {
        sort(fromIndex, toIndex, comparator, (i, j) -> {
            int swap = array[i];
            array[i] = array[j];
            array[j] = swap;
            return 0;
     ...
     * @param comparator Compares elements based on their indices. Given indices i
     *                   and j in the provided array, this comparator returns
     *                   respectively -1/0/1 if the element at index i is
     *                   respectively less/equal/greater than the element at index
     *                   j.
     * @param swapper    Swaps the elements in the array at the given indices. For
     *                   example, a custom swapper may allow sorting two arrays
     *                   simultaneously.
     */
     ...
     */
    private static void insertionSort(int fromIndex, int toIndex, IntBinaryOperator comparator,
                                      IntBinaryOperator swapper) {
