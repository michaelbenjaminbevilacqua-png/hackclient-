 ...
 * entries to another {@link LongObjectHashMap} as this may result in a runtime
 * deadlock. See
...
public class SortedIterationLongObjectHashMap<VType> implements LongObjectMap<VType> {
    ...
    private final class KeysContainer extends AbstractLongCollection implements LongLookupContainer {
        private final SortedIterationLongObjectHashMap<VType> owner = SortedIterationLongObjectHashMap.this;
