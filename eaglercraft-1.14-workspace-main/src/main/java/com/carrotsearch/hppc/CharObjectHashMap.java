...
/**
 * A hash map of <code>char</code> to <code>Object</code>, implemented using
...
public class CharObjectHashMap<VType> implements CharObjectMap<VType>, Preallocable, Cloneable, Accountable {
    /**
