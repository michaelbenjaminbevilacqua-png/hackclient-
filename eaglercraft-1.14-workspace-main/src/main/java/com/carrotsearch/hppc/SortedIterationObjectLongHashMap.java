 ...
 * entries to another {@link ObjectLongHashMap} as this may result in a runtime
 * deadlock. See
...
public class SortedIterationObjectLongHashMap<KType> implements ObjectLongMap<KType> {
     ...
     */
    public SortedIterationObjectLongHashMap(ObjectLongHashMap<KType> delegate, Comparator<KType> comparator) {
     ...
     */
    public SortedIterationObjectLongHashMap(ObjectLongHashMap<KType> delegate, ObjectLongComparator<KType> comparator) {
        this.delegate = delegate;
        this.iterationOrder = sortIterationOrder(createEntryIndexes(), comparator);
    }
    ...
    private final class KeysContainer extends AbstractObjectCollection<KType> implements ObjectLookupContainer<KType> {
        private final SortedIterationObjectLongHashMap<KType> owner = SortedIterationObjectLongHashMap.this;
