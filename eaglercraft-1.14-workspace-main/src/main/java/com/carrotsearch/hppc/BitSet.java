 ...
 *
 * <p>
 * Unlike {@link java.util.BitSet}, the fact that bits are packed into an array
 * of longs is part of the interface. This allows efficient implementation of
 * other algorithms by someone other than the author. It also allows one to
 * efficiently implement alternate serialization or interchange formats.
 *
 * <p>
 * The index range for a bitset can easily exceed positive <code>int</code>
 * range in Java (0x7fffffff), so many methods in this class accept or return a
 * <code>long</code>. There are adapter methods that return views compatible
 * with {@link LongLookupContainer} and {@link IntLookupContainer} interfaces.
 *
...
public class BitSet implements Cloneable {
     ...
     * @return Returns the popcount or cardinality of the intersection of the two
     ...
     * @param a The first set
     * @param b The second set
     * @return Returns the popcount or cardinality of the union of the two sets.
     ...
     * @param a The first set
     * @param b The second set
     * @return Returns the popcount or cardinality of "a and not b" or
     ...
     * @param a The first set
     * @param b The second set
     * @return Returns the popcount or cardinality of the exclusive-or of the two
     * sets. Neither set is modified.
     */
    ...
    /**
     * @return Returns an iterator over all set bits of this bitset. The iterator
     * should be faster than using a loop around {@link #nextSetBit(int)}.
     */
    ...
    /**
     * @return Returns the current capacity in bits (1 greater than the index of the
     * last bit).
     */
    ...
    /**
     * @return Returns the current capacity of this set. Included for compatibility.
     * This is <b>not</b> equal to {@link #cardinality}.
     * @see #cardinality()
    ...
    /**
     * @return Returns the "logical size" of this {@code BitSet}: the index of the
     * highest set bit in the {@code BitSet} plus one.
     ...
     * @return Returns the index of the first set bit starting at the index
    ...
    /**
     * Lowers {@link #wlen}, the number of words in use, by checking for trailing
     * zero words.
     */
     ...
     * {@link IntLookupContainer}. A new object is always returned, but its methods
     * reflect the current state of the bitset (the view is not a snapshot).
     *
     * <p>
     * Methods of the returned {@link IntLookupContainer} may throw a
     * {@link RuntimeException} if the cardinality of this bitset exceeds the int
     * range.
     *
    ...
    /**
     * Returns a view over this bitset data compatible with
     * {@link LongLookupContainer}. A new object is always returned, but its methods
     * reflect the current state of the bitset (the view is not a snapshot).
     *
