 ...
 * entries to another {@link ObjectShortHashMap} as this may result in a runtime
 * deadlock. See
...
public class SortedIterationObjectShortHashMap<KType> implements ObjectShortMap<KType> {
     ...
     */
    public SortedIterationObjectShortHashMap(ObjectShortHashMap<KType> delegate,
                                             ObjectShortComparator<KType> comparator) {
        this.delegate = delegate;
        this.iterationOrder = sortIterationOrder(createEntryIndexes(), comparator);
    }
    ...
    private final class KeysContainer extends AbstractObjectCollection<KType> implements ObjectLookupContainer<KType> {
        private final SortedIterationObjectShortHashMap<KType> owner = SortedIterationObjectShortHashMap.this;
