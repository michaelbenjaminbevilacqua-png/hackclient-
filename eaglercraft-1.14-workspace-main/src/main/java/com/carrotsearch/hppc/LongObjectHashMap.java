...
/**
 * A hash map of <code>long</code> to <code>Object</code>, implemented using
...
public class LongObjectHashMap<VType> implements LongObjectMap<VType>, Preallocable, Cloneable, Accountable {
    /**
