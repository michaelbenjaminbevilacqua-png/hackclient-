 ...
 * entries to another {@link ShortCharHashMap} as this may result in a runtime
 * deadlock. See
...
public class SortedIterationShortCharHashMap implements ShortCharMap {
     ...
     */
    public SortedIterationShortCharHashMap(ShortCharHashMap delegate, ShortCharComparator comparator) {
        this.delegate = delegate;
        this.iterationOrder = sortIterationOrder(createEntryIndexes(), comparator);
    }
