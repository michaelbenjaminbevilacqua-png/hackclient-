 ...
 * entries to another {@link ObjectIntHashMap} as this may result in a runtime
 * deadlock. See
...
public class SortedIterationObjectIntHashMap<KType> implements ObjectIntMap<KType> {
    ...
    private final class KeysContainer extends AbstractObjectCollection<KType> implements ObjectLookupContainer<KType> {
        private final SortedIterationObjectIntHashMap<KType> owner = SortedIterationObjectIntHashMap.this;
