...
/**
 * A hash set of <code>long</code>s, implemented using open addressing with
...
public class LongHashSet extends AbstractLongCollection
        implements LongLookupContainer, LongSet, Preallocable, Cloneable, Accountable {
    /**
     ...
     * <code>long</code>. The elements are copied from the argument to the internal
     * buffer.
     */
