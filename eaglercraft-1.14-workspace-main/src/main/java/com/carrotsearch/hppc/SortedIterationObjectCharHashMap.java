 ...
 * entries to another {@link ObjectCharHashMap} as this may result in a runtime
 * deadlock. See
...
public class SortedIterationObjectCharHashMap<KType> implements ObjectCharMap<KType> {
    ...
    private final class KeysContainer extends AbstractObjectCollection<KType> implements ObjectLookupContainer<KType> {
        private final SortedIterationObjectCharHashMap<KType> owner = SortedIterationObjectCharHashMap.this;
