...
/**
 * A hash map of <code>Object</code> to <code>float</code>, implemented using
...
public class ObjectFloatHashMap<KType> implements ObjectFloatMap<KType>, Preallocable, Cloneable, Accountable {
    /**
    ...
    private final class ValuesContainer extends AbstractFloatCollection {
        ...
        public int removeAll(final float e) {
            return owner.removeAll((key, value) -> (Float.floatToIntBits(e) == Float.floatToIntBits(value)));
        }
