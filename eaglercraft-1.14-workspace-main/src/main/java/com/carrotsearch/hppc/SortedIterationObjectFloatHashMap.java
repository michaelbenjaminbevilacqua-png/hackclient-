 ...
 * entries to another {@link ObjectFloatHashMap} as this may result in a runtime
 * deadlock. See
...
public class SortedIterationObjectFloatHashMap<KType> implements ObjectFloatMap<KType> {
     ...
     */
    public SortedIterationObjectFloatHashMap(ObjectFloatHashMap<KType> delegate, Comparator<KType> comparator) {
     ...
     */
    public SortedIterationObjectFloatHashMap(ObjectFloatHashMap<KType> delegate,
                                             ObjectFloatComparator<KType> comparator) {
        this.delegate = delegate;
        this.iterationOrder = sortIterationOrder(createEntryIndexes(), comparator);
    }
    ...
    private final class KeysContainer extends AbstractObjectCollection<KType> implements ObjectLookupContainer<KType> {
        private final SortedIterationObjectFloatHashMap<KType> owner = SortedIterationObjectFloatHashMap.this;
