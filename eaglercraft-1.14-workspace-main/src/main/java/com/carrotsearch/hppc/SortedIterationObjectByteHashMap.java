 ...
 * entries to another {@link ObjectByteHashMap} as this may result in a runtime
 * deadlock. See
...
public class SortedIterationObjectByteHashMap<KType> implements ObjectByteMap<KType> {
    ...
    private final class KeysContainer extends AbstractObjectCollection<KType> implements ObjectLookupContainer<KType> {
        private final SortedIterationObjectByteHashMap<KType> owner = SortedIterationObjectByteHashMap.this;
