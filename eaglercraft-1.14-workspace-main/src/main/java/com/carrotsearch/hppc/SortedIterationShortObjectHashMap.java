 ...
 * entries to another {@link ShortObjectHashMap} as this may result in a runtime
 * deadlock. See
...
public class SortedIterationShortObjectHashMap<VType> implements ShortObjectMap<VType> {
     ...
     */
    public SortedIterationShortObjectHashMap(ShortObjectHashMap<VType> delegate,
                                             ShortObjectComparator<VType> comparator) {
        this.delegate = delegate;
        this.iterationOrder = sortIterationOrder(createEntryIndexes(), comparator);
    }
    ...
    private final class KeysContainer extends AbstractShortCollection implements ShortLookupContainer {
        private final SortedIterationShortObjectHashMap<VType> owner = SortedIterationShortObjectHashMap.this;
