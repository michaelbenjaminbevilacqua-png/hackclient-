            ...
            while (true) {
                ...
                try {
                    ...
                    while (var26.hasNext()) {
                        ...
                        callback.onProfileLookupFailed(new GameProfile((EaglercraftUUID) null, name), new ProfileNotFoundException("Server did not find the requested profile"));
                    }
                    ...
                    if (failCount == 3) {
                        ...
                        while (var11.hasNext()) {
                            ...
                            callback.onProfileLookupFailed(new GameProfile((EaglercraftUUID) null, name), e);
                        }
                    } else {
                        EagUtils.sleep(750L);
