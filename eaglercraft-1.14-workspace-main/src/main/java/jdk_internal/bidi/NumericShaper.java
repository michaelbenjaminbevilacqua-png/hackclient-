 ...
 * {@link Range#ARABIC}. Multiple ranges can be specified by ORing
 ...
 * </pre>
 * 
 * </blockquote> or creating a {@code Set} with the {@link Range}
 ...
 * {@link Range#EASTERN_ARABIC}
 * <td>{@link Range#EASTERN_ARABIC} </tbody> <tbody>
 * <tr>
 * <th scope="row">Tai Tham
 * <td>{@link Range#TAI_THAM_HORA} <br>
 * {@link Range#TAI_THAM_THAM}
 * <td>{@link Range#TAI_THAM_THAM} </tbody>
 * </table>
 *
 * @since 1.4
 */
public final class NumericShaper implements java.io.Serializable {
	 ...
	 * its own decimal digits. For example, the {@link Range#THAI}
	 ...
	 * Unicode range.
	 *
	 * @param singleRange the Unicode range given by a {@link Range}
	 *                    constant.
