 ...
 * happens in {@link #ensureCapacity(Object[], int, int)} and
 * {@link #grow(Object[], int, int)}, is <em>significantly slower</em> than using
 * <code>new</code>. This phenomenon is particularly evident in the first growth
 * phases of an array reallocated with doubling (or similar) logic.
 *
...
public class ObjectArrays {
     ...
     * same class as of those of <code>prototype</code>. In case of an empty array,
     * it tries to return {@link #EMPTY_ARRAY}, if possible.
     *
