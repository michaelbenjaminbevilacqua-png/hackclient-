...
public class Int2ObjectArrayMap<V> extends AbstractInt2ObjectMap<V> implements java.io.Serializable, Cloneable {
    ...
    private final class EntrySet extends AbstractObjectSet<Entry<V>> implements FastEntrySet<V> {
        @Override
        public ObjectIterator<Entry<V>> iterator() {
            return new AbstractObjectIterator<Entry<V>>() {
                ...
                public Entry<V> next() {
                    ...
                    return new BasicEntry<V>(key[next], (V) value[next++]);
                }
            };
        }
        ...
        public boolean contains(Object o) {
            ...
            return Int2ObjectArrayMap.this.containsKey(k)
                    && ((Int2ObjectArrayMap.this.get(k)) == null ? ((e.getValue())) == null
                    : (Int2ObjectArrayMap.this.get(k)).equals((e.getValue())));
        }
    }
}