...
public class Object2LongMaps {
    ...
    public static class Singleton<K> extends Object2LongFunctions.Singleton<K>
        ...
        protected class SingletonEntry implements Entry<K>, Map.Entry<K, Long> {
            public K getKey() {
            ...
            public boolean equals(final Object o) {
                ...
                return ((Singleton.this.key) == null ? ((e.getKey())) == null
                        ...
                        && ((Singleton.this.value) == (((((Long) (e.getValue())).longValue()))));
            }

            public int hashCode() {
                return ((Singleton.this.key) == null ? 0 : (Singleton.this.key).hashCode())
                        ^ it.unimi.dsi.fastutil.HashCommon.long2int(Singleton.this.value);
            }
    ...
    public static class SynchronizedMap<K> extends Object2LongFunctions.SynchronizedFunction<K>
        ...
        public long removeLong(final Object k) {
            synchronized (sync) {
                return map.removeLong(k);
            }
        }

        public long getLong(final Object k) {
            synchronized (sync) {
                return map.getLong(k);
            }
        }
