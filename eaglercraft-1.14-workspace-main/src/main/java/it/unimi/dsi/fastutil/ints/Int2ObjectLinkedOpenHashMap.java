...
public class Int2ObjectLinkedOpenHashMap<V> extends AbstractInt2ObjectSortedMap<V>
    ...
    private class MapIterator {
        ...
        private MapIterator(final int from) {
            if (((key[last]) == (from))) {
                ...
                // The starting point.
                int pos = (HashCommon.murmurHash3((from))) & mask;
                // There's always an unused entry.
                while (used[pos]) {
                    if (((key[pos]) == (from))) {
    ...
    private final class KeySet extends AbstractIntSortedSet {
        ...
        final public IntSortedSet tailSet(int from) {
            throw new UnsupportedOperationException();
        }

        final public IntSortedSet headSet(int to) {
            throw new UnsupportedOperationException();
        }

        final public IntSortedSet subSet(int from, int to) {
            throw new UnsupportedOperationException();
        }
    }
