...
public class Long2ObjectLinkedOpenHashMap<V> extends AbstractLong2ObjectSortedMap<V>
    ...
    private class EntryIterator extends MapIterator implements ObjectListIterator<Entry<V>> {
    ...
    private class FastEntryIterator extends MapIterator implements ObjectListIterator<Entry<V>> {
    ...
    private final class MapEntrySet extends AbstractObjectSortedSet<Entry<V>>
        ...
        public ObjectSortedSet<Entry<V>> subSet(Entry<V> fromElement,
                                                Entry<V> toElement) {
            throw new UnsupportedOperationException();
        }
        ...
        public ObjectBidirectionalIterator<Entry<V>> iterator(final Entry<V> from) {
        ...
        public ObjectBidirectionalIterator<Entry<V>> fastIterator(final Entry<V> from) {
