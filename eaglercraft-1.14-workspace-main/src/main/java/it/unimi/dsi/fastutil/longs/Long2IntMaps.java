...
public class Long2IntMaps {
    ...
    public static class Singleton extends Long2IntFunctions.Singleton
        ...
        protected transient volatile ObjectSet<Entry> entries;
        ...
        public ObjectSet<Entry> long2IntEntrySet() {
            if (entries == null)
                entries = ObjectSets.singleton((Entry) new SingletonEntry());
            return entries;
        }
        ...
        protected class SingletonEntry implements Entry, Map.Entry<Long, Integer> {
            public Long getKey() {
