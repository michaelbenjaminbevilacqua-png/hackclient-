...
public interface Object2FloatFunction<K> extends Function<K, Float> {
     ...
     * <p>
     * This value must be returned by type-specific versions of <code>get()</code>,
     * <code>put()</code> and <code>remove()</code> to denote that the map does not
     * contain the specified key. It must be 0/<code>false</code>/<code>null</code>
     * by default.
     *
