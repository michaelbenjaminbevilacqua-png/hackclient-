...
public class Int2DoubleOpenHashMap extends AbstractInt2DoubleMap implements java.io.Serializable, Cloneable, Hash {
    ...
    public Double get(final Integer ok) {
        ...
        while (used[pos]) {
            if (((key[pos]) == (k)))
                return (Double.valueOf(value[pos]));
            pos = (pos + 1) & mask;
        }
        return (null);
    }
     ...
     * the map
     */
    private final class MapEntry implements Entry, Map.Entry<Integer, Double> {
        ...
        public boolean equals(final Object o) {
            ...
            return ((key[index]) == (((e.getKey()).intValue())))
                    && ((value[index]) == (((e.getValue()).doubleValue())));
        }
    ...
    private final class MapEntrySet extends AbstractObjectSet<Entry> implements FastEntrySet {
        ...
        public boolean contains(final Object o) {
            ...
            while (used[pos]) {
                if (((key[pos]) == (k)))
                    return ((value[pos]) == (((e.getValue()).doubleValue())));
                pos = (pos + 1) & mask;
            }
            return false;
        }
