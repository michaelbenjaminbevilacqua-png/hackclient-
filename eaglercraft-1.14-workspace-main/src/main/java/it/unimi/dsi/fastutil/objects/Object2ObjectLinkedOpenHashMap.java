...
public class Object2ObjectLinkedOpenHashMap<K, V> extends AbstractObject2ObjectSortedMap<K, V>
    ...
    private class EntryIterator extends MapIterator implements ObjectListIterator<Entry<K, V>> {
    ...
    private class FastEntryIterator extends MapIterator implements ObjectListIterator<Entry<K, V>> {
    ...
    private final class MapEntrySet extends AbstractObjectSortedSet<Entry<K, V>>
        ...
        public ObjectSortedSet<Entry<K, V>> subSet(Entry<K, V> fromElement,
                                                   Entry<K, V> toElement) {
            throw new UnsupportedOperationException();
        }

        public ObjectSortedSet<Entry<K, V>> headSet(Entry<K, V> toElement) {
            throw new UnsupportedOperationException();
        }

        public ObjectSortedSet<Entry<K, V>> tailSet(Entry<K, V> fromElement) {
            throw new UnsupportedOperationException();
        }
        ...
        public ObjectBidirectionalIterator<Entry<K, V>> fastIterator() {
