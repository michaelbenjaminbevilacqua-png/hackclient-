...
public class Int2ObjectMaps {
    ...
    public static class Singleton<V> extends Int2ObjectFunctions.Singleton<V>
        ...
        protected transient volatile ObjectSet<Entry<V>> entries;
        ...
        public ObjectSet<Entry<V>> int2ObjectEntrySet() {
            if (entries == null)
                entries = ObjectSets.singleton((Entry<V>) new SingletonEntry());
            return entries;
        }
        ...
        protected class SingletonEntry implements Entry<V>, Map.Entry<Integer, V> {
            public Integer getKey() {
                return (Integer.valueOf(Singleton.this.key));
            }
            ...
            public boolean equals(final Object o) {
                ...
                return ((Singleton.this.key) == (((((Integer) (e.getKey())).intValue()))))
