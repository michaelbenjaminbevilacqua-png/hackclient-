...
public class Long2FloatLinkedOpenHashMap extends AbstractLong2FloatSortedMap
    ...
    public Float get(final Long ok) {
        ...
        while (used[pos]) {
            if (((key[pos]) == (k)))
                return (Float.valueOf(value[pos]));
            pos = (pos + 1) & mask;
        }
        return (null);
    }
     ...
     * the map
     */
    private final class MapEntry implements Entry, Map.Entry<Long, Float> {
    ...
    private class MapIterator {
        ...
        private MapIterator(final long from) {
            if (((key[last]) == (from))) {
                ...
                // The starting point.
                int pos = (int) HashCommon.murmurHash3(from) & mask;
                // There's always an unused entry.
                while (used[pos]) {
                    if (((key[pos]) == (from))) {
    ...
    private class EntryIterator extends MapIterator implements ObjectListIterator<Entry> {
        ...
        public void set(Entry ok) {
            throw new UnsupportedOperationException();
        }

        public void add(Entry ok) {
            throw new UnsupportedOperationException();
        }
    }

    private class FastEntryIterator extends MapIterator implements ObjectListIterator<Entry> {
    ...
    private final class MapEntrySet extends AbstractObjectSortedSet<Entry> implements FastSortedEntrySet {
        ...
        public ObjectSortedSet<Entry> subSet(Entry fromElement,
                                             Entry toElement) {
            throw new UnsupportedOperationException();
        }
        ...
        public ObjectBidirectionalIterator<Entry> fastIterator(final Entry from) {
    ...
    private final class KeyIterator extends MapIterator implements LongListIterator {
        ...
        public Long previous() {
            return (Long.valueOf(key[previousEntry()]));
        }
    ...
    private final class KeySet extends AbstractLongSortedSet {
        ...
        final public LongSortedSet tailSet(long from) {
            throw new UnsupportedOperationException();
        }

        final public LongSortedSet headSet(long to) {
            throw new UnsupportedOperationException();
        }

        final public LongSortedSet subSet(long from, long to) {
            throw new UnsupportedOperationException();
        }
    }
    ...
    private final class ValueIterator extends MapIterator implements FloatListIterator {
        ...
        public Float previous() {
            return (Float.valueOf(value[previousEntry()]));
        }
