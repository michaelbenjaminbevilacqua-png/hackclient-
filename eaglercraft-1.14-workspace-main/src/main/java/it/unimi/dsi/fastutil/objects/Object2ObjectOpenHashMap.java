...
public class Object2ObjectOpenHashMap<K, V> extends AbstractObject2ObjectMap<K, V>
     ...
     * the map
     */
    private final class MapEntry implements Entry<K, V>, Map.Entry<K, V> {
        ...
        public boolean equals(final Object o) {
            ...
            return ((key[index]) == null ? ((e.getKey())) == null : (key[index]).equals((e.getKey())))
                    && ((value[index]) == null ? ((e.getValue())) == null : (value[index]).equals((e.getValue())));
        }
    ...
    private class EntryIterator extends MapIterator implements ObjectIterator<Entry<K, V>> {
    ...
    private class FastEntryIterator extends MapIterator implements ObjectIterator<Entry<K, V>> {
