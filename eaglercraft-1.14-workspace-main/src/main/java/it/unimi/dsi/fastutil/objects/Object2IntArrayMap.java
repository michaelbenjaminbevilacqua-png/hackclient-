...
public class Object2IntArrayMap<K> extends AbstractObject2IntMap<K> implements java.io.Serializable, Cloneable {
    ...
    private final class EntrySet extends AbstractObjectSet<Entry<K>> implements FastEntrySet<K> {
        @Override
        public ObjectIterator<Entry<K>> iterator() {
            return new AbstractObjectIterator<Entry<K>>() {
                int next = 0;
                ...
                public Entry<K> next() {
                    ...
                    return new BasicEntry<K>((K) key[next], value[next++]);
                }
            };
        }
        ...
        public boolean contains(Object o) {
            ...
            return Object2IntArrayMap.this.containsKey(k)
                    && ((Object2IntArrayMap.this.getInt(k)) == (((e.getValue()).intValue())));
        }
    }
}