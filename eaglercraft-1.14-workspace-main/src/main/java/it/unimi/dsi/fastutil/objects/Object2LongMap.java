...
public interface Object2LongMap<K> extends Object2LongFunction<K>, Map<K, Long> {
     ...
     * it returns an {@link ObjectSet} of objects of
     * type {@link Map.Entry} (the latter makes it possible to access keys
     ...
     * the creation of a large number of {@link Map.Entry} objects. Some
    ...
    public interface FastEntrySet<K> extends ObjectSet<Entry<K>> {
         ...
         * the same {@link Map.Entry} object, suitably mutated.
         */
