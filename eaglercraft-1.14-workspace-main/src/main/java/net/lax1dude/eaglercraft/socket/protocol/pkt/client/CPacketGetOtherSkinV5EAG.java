...
public class CPacketGetOtherSkinV5EAG implements GameMessagePacket {
    public int requestId;
    public long uuidMost;
    public long uuidLeast;

    public CPacketGetOtherSkinV5EAG() {
    }

    public CPacketGetOtherSkinV5EAG(int requestId, long uuidMost, long uuidLeast) {
