...
public class DamageSource {
    ...
    public static DamageSource causeArrowDamage(AbstractArrowEntity arrow, Entity indirectEntityIn) {
        return (new IndirectEntityDamageSource("arrow", arrow, indirectEntityIn)).setProjectile();
    }

    public static DamageSource causeTridentDamage(Entity source, Entity indirectEntityIn) {
        return (new IndirectEntityDamageSource("trident", source, indirectEntityIn)).setProjectile();
    }

    public static DamageSource causeFireballDamage(DamagingProjectileEntity fireball, Entity indirectEntityIn) {
    ...
    public static DamageSource causeExplosionDamage(LivingEntity entityLivingBaseIn) {
