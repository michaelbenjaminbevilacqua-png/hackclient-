...
public class WorldOptimizer {
    ...
    public WorldOptimizer(String p_i50400_1_, SaveFormat p_i50400_2_, WorldInfo p_i50400_3_, boolean p_i50400_4_) {
        ...
        this.savedDataManager = new DimensionSavedDataManager(new VFile2(DimensionType.OVERWORLD.getDirectory(this.worldStorage.getWorldDirectory()), "data"), this.worldStorage.getFixer());
    ...
    private void optimize() {
        ...
        if (this.totalChunks == 0) {
            ...
            for (DimensionType dimensiontype1 : DimensionType.getAll()) {
                VFile2 file2 = dimensiontype1.getDirectory(file1);
                builder1.put(dimensiontype1, new ChunkLoader(new java.io.File(new net.lax1dude.eaglercraft.internal.vfs2.VFile2(file2, "region").getPath()), this.worldStorage.getFixer()));
            }
    ...
    private List<ChunkPos> func_219953_b(DimensionType p_219953_1_) {
        VFile2 file1 = p_219953_1_.getDirectory(this.folder);
        VFile2 file2 = new VFile2(file1, "region");
