...
public final class EntityPredicates {
    ...
    public static java.util.function.Predicate<Entity> pushableBy(Entity entityIn) {
        ...
        return (team$collisionrule == Team.CollisionRule.NEVER ? p -> false : NOT_SPECTATING.and((p_210290_3_) -> {
    ...
    public static class ArmoredMob implements Predicate<Entity> {
        ...
        public boolean test(Entity p_test_1_) {
