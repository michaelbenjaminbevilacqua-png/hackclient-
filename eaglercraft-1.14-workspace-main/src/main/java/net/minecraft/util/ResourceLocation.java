...
public class ResourceLocation implements Comparable<ResourceLocation> {
   ...
   private static boolean func_217856_c(String pathIn) {
      for(int i = 0; i < pathIn.length(); ++i) {
         int p_217857_0_ = pathIn.charAt(i);
         if (!(p_217857_0_ == 95 || p_217857_0_ == 45 || p_217857_0_ >= 97 && p_217857_0_ <= 122 || p_217857_0_ >= 48 && p_217857_0_ <= 57 || p_217857_0_ == 47 || p_217857_0_ == 46)) {
            return false;
         }
      }
      return true;
   ...
   private static boolean func_217858_d(String namespaceIn) {
      for(int i = 0; i < namespaceIn.length(); ++i) {
         int p_217859_0_ = namespaceIn.charAt(i);
         if (!(p_217859_0_ == 95 || p_217859_0_ == 45 || p_217859_0_ >= 97 && p_217859_0_ <= 122 || p_217859_0_ >= 48 && p_217859_0_ <= 57 || p_217859_0_ == 46)) {
            return false;
         }
      }
      return true;
