...
public abstract class NBTTextComponent extends TextComponent implements ITargetedTextComponent {
   ...
   protected NBTTextComponent(String p_i50782_1_,  NBTPathArgument.NBTPath p_i50782_2_, boolean p_i50782_3_) {
   ...
   public ITextComponent createNames( CommandSource p_197668_1_,  net.minecraft.entity.Entity p_197668_2_, int p_197668_3_) throws CommandSyntaxException {
   ...
   public static class Block extends NBTTextComponent {
      ...
      private Block(String p_i51295_1_,  NBTPathArgument.NBTPath p_i51295_2_, boolean p_i51295_3_, String p_i51295_4_,  ILocationArgument p_i51295_5_) {
   ...
   public static class Entity extends NBTTextComponent {
      ...
      private Entity(String p_i51293_1_,  NBTPathArgument.NBTPath p_i51293_2_, boolean p_i51293_3_, String p_i51293_4_,  EntitySelector p_i51293_5_) {
