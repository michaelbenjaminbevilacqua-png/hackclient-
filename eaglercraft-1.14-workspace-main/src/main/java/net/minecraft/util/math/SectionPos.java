...
public class SectionPos extends Vec3i {
    ...
    public static Stream<SectionPos> getAllInBox(final int p_218168_0_, final int p_218168_1_, final int p_218168_2_, final int p_218168_3_, final int p_218168_4_, final int p_218168_5_) {
        int i = p_218168_3_ - p_218168_0_ + 1;
        int j = p_218168_4_ - p_218168_1_ + 1;
        int k = p_218168_5_ - p_218168_2_ + 1;
        java.util.List<SectionPos> list = new java.util.ArrayList<>(i * j * k);
        CubeCoordinateIterator iter = new CubeCoordinateIterator(p_218168_0_, p_218168_1_, p_218168_2_, p_218168_3_, p_218168_4_, p_218168_5_);
        while (iter.hasNext()) {
            list.add(new SectionPos(iter.getX(), iter.getY(), iter.getZ()));
        }
        return list.stream();
    }
}
