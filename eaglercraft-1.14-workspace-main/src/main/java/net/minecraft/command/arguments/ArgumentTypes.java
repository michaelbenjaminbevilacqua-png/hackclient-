...
public class ArgumentTypes {
   ...
   private static final Map<String, ArgumentTypes.Entry<?>> CLASS_TYPE_MAP = Maps.newHashMap();
   ...
   public static <T extends ArgumentType<?>> void register(String p_218136_0_, Class<T> p_218136_1_, IArgumentSerializer<T> p_218136_2_) {
      ...
      String s = p_218136_1_.getName();
      if (CLASS_TYPE_MAP.containsKey(s)) {
         throw new IllegalArgumentException("Class " + s + " already has a serializer!");
