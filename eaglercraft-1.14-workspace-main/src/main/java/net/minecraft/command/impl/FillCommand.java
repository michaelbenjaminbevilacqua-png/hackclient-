...
public class FillCommand {
    ...
    private static int doFill(CommandSource source, MutableBoundingBox area, BlockStateInput newBlock, FillCommand.Mode mode, Predicate<CachedBlockInfo> replacingPredicate) throws CommandSyntaxException {
