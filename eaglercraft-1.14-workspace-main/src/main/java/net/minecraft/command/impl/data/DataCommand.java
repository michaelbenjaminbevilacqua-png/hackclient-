...
public class DataCommand {
   ...
   public static final List<DataCommand.IDataProvider> field_218955_b = ImmutableList.copyOf(DATA_PROVIDERS.stream().map((p_218925_0_) -> {
      return p_218925_0_.apply("target");
   }).collect(Collectors.toList()));
   public static final List<DataCommand.IDataProvider> field_218956_c = ImmutableList.copyOf(DATA_PROVIDERS.stream().map((p_218947_0_) -> {
