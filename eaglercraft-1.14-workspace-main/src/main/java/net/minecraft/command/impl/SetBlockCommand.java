...
public class SetBlockCommand {
   ...
   private static int setBlock(CommandSource source, BlockPos pos, BlockStateInput state, SetBlockCommand.Mode mode,  Predicate<CachedBlockInfo> predicate) throws CommandSyntaxException {
