...
public class BanIpCommand {
   ...
   private static int banUsernameOrIp(CommandSource source, String username,  ITextComponent reason) throws CommandSyntaxException {
   ...
   private static int banIpAddress(CommandSource source, String ip,  ITextComponent reason) throws CommandSyntaxException {
