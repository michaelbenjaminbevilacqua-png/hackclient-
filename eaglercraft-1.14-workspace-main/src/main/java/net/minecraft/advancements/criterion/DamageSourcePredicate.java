...
public class DamageSourcePredicate {
   ...
   public DamageSourcePredicate( Boolean p_i50810_1_,  Boolean p_i50810_2_,  Boolean p_i50810_3_,  Boolean p_i50810_4_,  Boolean p_i50810_5_,  Boolean p_i50810_6_,  Boolean p_i50810_7_,  Boolean p_i50810_8_, EntityPredicate p_i50810_9_, EntityPredicate p_i50810_10_) {
   ...
   private void addProperty(JsonObject obj, String key,  Boolean value) {
      if (value != null) {
