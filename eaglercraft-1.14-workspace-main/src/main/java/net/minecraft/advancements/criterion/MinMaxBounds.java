...
public abstract class MinMaxBounds<T extends Number> {
    ...
    protected static <T extends Number, R extends MinMaxBounds<T>> R fromJson(JsonElement p_211331_0_, R p_211331_1_, BiFunction<JsonElement, String, T> p_211331_2_, MinMaxBounds.IBoundFactory<T, R> p_211331_3_) {
    ...
    public static class FloatBound extends MinMaxBounds<Float> {
        ...
        private static MinMaxBounds.FloatBound create(StringReader p_211352_0_, Float p_211352_1_, Float p_211352_2_) throws CommandSyntaxException {
        ...
        private FloatBound(Float p_i49717_1_, Float p_i49717_2_) {
        ...
        public static MinMaxBounds.FloatBound fromJson(JsonElement p_211356_0_) {
    ...
    public static class IntBound extends MinMaxBounds<Integer> {
        ...
        private static MinMaxBounds.IntBound create(StringReader p_211338_0_, Integer p_211338_1_, Integer p_211338_2_) throws CommandSyntaxException {
        ...
        private IntBound(Integer p_i49716_1_, Integer p_i49716_2_) {
        ...
        public static MinMaxBounds.IntBound fromJson(JsonElement p_211344_0_) {
