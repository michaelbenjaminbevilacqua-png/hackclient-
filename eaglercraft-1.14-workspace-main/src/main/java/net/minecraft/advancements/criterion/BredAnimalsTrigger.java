...
public class BredAnimalsTrigger implements ICriterionTrigger<BredAnimalsTrigger.Instance> {
    ...
    public void trigger(ServerPlayerEntity player, AnimalEntity parent1, AnimalEntity parent2, AgeableEntity child) {
    ...
    public static class Instance extends CriterionInstance {
        ...
        public boolean test(ServerPlayerEntity player, AnimalEntity parent1In, AnimalEntity parent2In, AgeableEntity childIn) {
