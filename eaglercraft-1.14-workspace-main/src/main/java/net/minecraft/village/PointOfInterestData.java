...
public class PointOfInterestData implements IDynamicSerializable {
    ...
    public <T> PointOfInterestData(Runnable p_i50294_1_, Dynamic<T> p_i50294_2_) {
        ...
        try {
            ...
            p_i50294_2_.get("Records").asStream().forEach((p_218252_1_) -> {
                this.func_218254_a(new PointOfInterest(p_218252_1_, this.onChange));
            });
    ...
    public void remove(BlockPos p_218248_1_) {
        ...
        if (pointofinterest == null) {
            field_218255_a.error("POI data mismatch: never registered at {}", (Object) p_218248_1_);
        } else {
