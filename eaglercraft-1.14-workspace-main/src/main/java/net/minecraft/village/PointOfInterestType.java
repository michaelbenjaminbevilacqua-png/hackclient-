...
public class PointOfInterestType {
    ...
    private static final Set<BlockState> BED_HEADS = Arrays.asList(
                    Blocks.RED_BED, Blocks.BLACK_BED, Blocks.BLUE_BED, Blocks.BROWN_BED, Blocks.CYAN_BED, Blocks.GRAY_BED,
                    Blocks.GREEN_BED, Blocks.LIGHT_BLUE_BED, Blocks.LIGHT_GRAY_BED, Blocks.LIME_BED, Blocks.MAGENTA_BED,
                    Blocks.ORANGE_BED, Blocks.PINK_BED, Blocks.PURPLE_BED, Blocks.WHITE_BED, Blocks.YELLOW_BED
            ).stream()
            .flatMap(b -> b.getStateContainer().getValidStates().stream())
    ...
    private PointOfInterestType(String p_i51553_1_, Set<BlockState> p_i51553_2_, int p_i51553_3_, SoundEvent p_i51553_4_, Predicate<PointOfInterestType> p_i51553_5_, int p_i51553_6_) {
    ...
    private PointOfInterestType(String p_i51554_1_, Set<BlockState> p_i51554_2_, int p_i51554_3_, SoundEvent p_i51554_4_, int p_i51554_5_) {
    ...
    private static PointOfInterestType register(String key, Set<BlockState> p_221051_1_, int p_221051_2_, SoundEvent p_221051_3_, int p_221051_4_) {
    ...
    private static PointOfInterestType register(String key, Set<BlockState> p_221039_1_, int p_221039_2_, SoundEvent p_221039_3_, Predicate<PointOfInterestType> p_221039_4_, int p_221039_5_) {
