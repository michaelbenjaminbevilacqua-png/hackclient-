...
public class PointOfInterestManager extends RegionSectionCache<PointOfInterestData> {
    ...
    public PointOfInterestManager(VFile2 p_i50298_1_, DataFixer p_i50298_2_) {
        super(new java.io.File(p_i50298_1_.getPath()), PointOfInterestData::new, PointOfInterestData::new, p_i50298_2_, DefaultTypeReferences.POI_CHUNK);
    }
