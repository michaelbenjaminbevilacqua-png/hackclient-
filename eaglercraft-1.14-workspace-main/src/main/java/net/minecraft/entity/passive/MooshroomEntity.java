...
public class MooshroomEntity extends CowEntity {
    ...
    private EaglercraftUUID lightningUUID;
    ...
    public static boolean func_223318_c(EntityType<MooshroomEntity> p_223318_0_, IWorld p_223318_1_, SpawnReason p_223318_2_, BlockPos p_223318_3_, Random p_223318_4_) {
        return p_223318_1_.getBlockState(p_223318_3_.down()).getBlock() == Blocks.MYCELIUM && (p_223318_2_ == SpawnReason.CHUNK_GENERATION || p_223318_1_.getLightSubtracted(p_223318_3_, 0) > 8);
    }

    public void onStruckByLightning(LightningBoltEntity lightningBolt) {
        EaglercraftUUID uuid = lightningBolt.getUniqueID();
