...
public abstract class AbstractHorseEntity extends AnimalEntity implements IInventoryChangedListener, IJumpingMount {
    ...
    private static final DataParameter<Optional<EaglercraftUUID>> OWNER_UNIQUE_ID = EntityDataManager.createKey(AbstractHorseEntity.class, DataSerializers.OPTIONAL_UNIQUE_ID);
    ...
    public void setOwnerUniqueId(EaglercraftUUID uniqueId) {
    ...
    public void readAdditional(CompoundNBT compound) {
        ...
        if (!s.isEmpty()) {
            this.setOwnerUniqueId(EaglercraftUUID.fromString(s));
        }
