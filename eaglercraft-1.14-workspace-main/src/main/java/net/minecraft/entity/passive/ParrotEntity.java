...
public class ParrotEntity extends ShoulderRidingEntity implements IFlyingAnimal {
   ...
   private static final Predicate<MobEntity> CAN_MIMIC = new Predicate<MobEntity>() {
      public boolean test( MobEntity p_test_1_) {
   ...
   public static boolean func_223317_c(EntityType<ParrotEntity> p_223317_0_, IWorld p_223317_1_, SpawnReason p_223317_2_, BlockPos p_223317_3_, Random p_223317_4_) {
      ...
      return (block.isIn(BlockTags.LEAVES) || block == Blocks.GRASS_BLOCK || block instanceof LogBlock || block == Blocks.AIR) && (p_223317_2_ == SpawnReason.CHUNK_GENERATION || p_223317_1_.getLightSubtracted(p_223317_3_, 0) > 8);
   }
