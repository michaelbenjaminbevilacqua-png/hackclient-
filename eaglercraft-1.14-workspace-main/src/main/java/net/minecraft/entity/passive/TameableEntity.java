...
public abstract class TameableEntity extends AnimalEntity {
    ...
    protected static final DataParameter<Optional<EaglercraftUUID>> OWNER_UNIQUE_ID = EntityDataManager.createKey(TameableEntity.class, DataSerializers.OPTIONAL_UNIQUE_ID);
    ...
    public void setOwnerId(EaglercraftUUID p_184754_1_) {
