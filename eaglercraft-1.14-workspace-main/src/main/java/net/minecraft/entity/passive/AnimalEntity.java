...
public abstract class AnimalEntity extends AgeableEntity {
    ...
    public static boolean func_223316_b(EntityType<? extends AnimalEntity> p_223316_0_, IWorld p_223316_1_, SpawnReason p_223316_2_, BlockPos p_223316_3_, Random p_223316_4_) {
        return p_223316_1_.getBlockState(p_223316_3_.down()).getBlock() == Blocks.GRASS_BLOCK && (p_223316_2_ == SpawnReason.CHUNK_GENERATION || p_223316_1_.getLightSubtracted(p_223316_3_, 0) > 8);
    }
    ...
    public boolean canMateWith(AnimalEntity otherAnimal) {
        if (otherAnimal == this) {
            return false;
        } else if (otherAnimal == null || otherAnimal.getClass() != this.getClass()) {
            return false;
        } else {
