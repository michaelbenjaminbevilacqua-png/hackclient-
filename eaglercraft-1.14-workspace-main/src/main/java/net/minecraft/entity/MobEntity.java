...
public abstract class MobEntity extends LivingEntity {
    ...
    public void writeAdditional(CompoundNBT compound) {
        ...
        if (this.leashHolder != null) {
            ...
            if (this.leashHolder instanceof LivingEntity) {
                EaglercraftUUID uuid = this.leashHolder.getUniqueID();
                compoundnbt2.putUniqueId("EaglercraftUUID", uuid);
    ...
    private void recreateLeash() {
        if (this.leashNBTTag != null && this.world instanceof ServerWorld) {
            if (this.leashNBTTag.hasUniqueId("EaglercraftUUID")) {
                EaglercraftUUID uuid = this.leashNBTTag.getUniqueId("EaglercraftUUID");
