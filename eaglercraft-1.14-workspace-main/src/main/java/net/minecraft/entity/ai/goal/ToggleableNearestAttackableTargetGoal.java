...
public class ToggleableNearestAttackableTargetGoal<T extends LivingEntity> extends NearestAttackableTargetGoal<T> {
   ...
   public ToggleableNearestAttackableTargetGoal(AbstractRaiderEntity p_i50312_1_, Class<T> p_i50312_2_, int p_i50312_3_, boolean p_i50312_4_, boolean p_i50312_5_,  Predicate<LivingEntity> p_i50312_6_) {
