...
public class AttributeModifier {
   ...
   public AttributeModifier(EaglercraftUUID uuid, String nameIn, double amountIn, AttributeModifier.Operation operationIn) {
      this(uuid, () -> {
         return nameIn;
      }, amountIn, operationIn);
   }

   public AttributeModifier(EaglercraftUUID uuid, Supplier<String> nameIn, double amountIn, AttributeModifier.Operation operationIn) {
      this.id = uuid;
      this.name = nameIn;
