...
public class EntityType<T extends Entity> {
   ...
   public static void applyItemNBT(World worldIn,  PlayerEntity player,  Entity spawnedEntity,  CompoundNBT itemNBT) {
      if (itemNBT != null && itemNBT.contains("EntityTag", 10)) {
         ...
         if (minecraftserver != null && spawnedEntity != null) {
            if (worldIn.isRemote || !spawnedEntity.ignoreItemEntityData() || player != null && minecraftserver.getPlayerList().canSendCommands(player.getGameProfile())) {
               ...
               EaglercraftUUID uuid = spawnedEntity.getUniqueID();
   ...
   public T create(World worldIn) {
      if (!baseEntityClassesInitialized) {
         baseEntityClassesInitialized = true;
         net.minecraft.entity.Entity.ensureInitialized();
         net.minecraft.entity.LivingEntity.ensureInitialized();
         net.minecraft.entity.MobEntity.ensureInitialized();
         net.minecraft.entity.AgeableEntity.ensureInitialized();
         net.minecraft.entity.passive.TameableEntity.ensureInitialized();
         net.minecraft.entity.merchant.villager.AbstractVillagerEntity.ensureInitialized();
         net.minecraft.entity.passive.horse.AbstractHorseEntity.ensureInitialized();
         net.minecraft.entity.passive.horse.AbstractChestedHorseEntity.ensureInitialized();
         net.minecraft.entity.monster.AbstractRaiderEntity.ensureInitialized();
         net.minecraft.entity.monster.SpellcastingIllagerEntity.ensureInitialized();
         net.minecraft.entity.monster.ZombieEntity.ensureInitialized();
         net.minecraft.entity.passive.fish.AbstractFishEntity.ensureInitialized();
         net.minecraft.entity.projectile.AbstractArrowEntity.ensureInitialized();
         net.minecraft.entity.item.minecart.AbstractMinecartEntity.ensureInitialized();
      }
