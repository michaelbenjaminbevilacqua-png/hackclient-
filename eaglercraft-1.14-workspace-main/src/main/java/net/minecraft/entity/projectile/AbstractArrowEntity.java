...
public abstract class AbstractArrowEntity extends Entity implements IProjectile {
    ...
    protected static final DataParameter<Optional<EaglercraftUUID>> field_212362_a = EntityDataManager.createKey(AbstractArrowEntity.class, DataSerializers.OPTIONAL_UNIQUE_ID);
    ...
    public EaglercraftUUID shootingEntity;
    ...
    public void setShooter(Entity p_212361_1_) {
