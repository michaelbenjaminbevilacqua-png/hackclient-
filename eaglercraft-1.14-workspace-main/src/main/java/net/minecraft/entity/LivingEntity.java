...
public abstract class LivingEntity extends Entity {
    private static final EaglercraftUUID SPRINTING_SPEED_BOOST_ID = EaglercraftUUID.fromString("662A6B8D-DA3E-4C1C-8813-96EA6097278D");
    ...
    protected LivingEntity(EntityType<? extends LivingEntity> type, World p_i48577_2_) {
        ...
        this.brain = this.createBrain(new com.mojang.datafixers.Dynamic<>(NBTDynamicOps.INSTANCE, new CompoundNBT()));
    }
