...
public abstract class FlowingFluid extends Fluid {
   ...
   private static final ThreadLocal<Object2ByteLinkedOpenHashMap<Block.RenderSideCacheKey>> field_212756_e = new ThreadLocal<Object2ByteLinkedOpenHashMap<Block.RenderSideCacheKey>>() {
      @Override
