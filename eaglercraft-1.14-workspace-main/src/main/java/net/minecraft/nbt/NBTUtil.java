...
public final class NBTUtil {
    ...
    @VisibleForTesting
    public static boolean areNBTEquals(INBT nbt1, INBT nbt2, boolean compareTagList) {
        if (nbt1 == nbt2) {
            return true;
        } else if (nbt1 == null) {
            return true;
    ...
    public static CompoundNBT writeUniqueId(EaglercraftUUID uuid) {
        CompoundNBT compoundnbt = new CompoundNBT();
    ...
    public static EaglercraftUUID readUniqueId(CompoundNBT tag) {
