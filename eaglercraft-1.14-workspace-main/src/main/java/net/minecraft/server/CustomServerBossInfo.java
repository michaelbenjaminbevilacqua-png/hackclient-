...
public class CustomServerBossInfo extends ServerBossInfo {
   ...
   private final Set<EaglercraftUUID> players = Sets.newHashSet();
   private int value;
   private int max = 100;
   ...
   public void addPlayer(EaglercraftUUID player) {
   ...
   public boolean setPlayers(Collection<ServerPlayerEntity> p_201368_1_) {
      Set<EaglercraftUUID> set = Sets.newHashSet();
      Set<ServerPlayerEntity> set1 = Sets.newHashSet();

      for(EaglercraftUUID uuid : this.players) {
         boolean flag = false;
      ...
      for(ServerPlayerEntity serverplayerentity1 : p_201368_1_) {
         ...
         for(EaglercraftUUID uuid2 : this.players) {
