   ...
   public void run() {
      while(this.server.isServerRunning()) {
         ...
         if (k > this.maxTickTime) {
            ...
            VFile2 file1 = new VFile2(new VFile2(this.server.getDataDirectory(), "crash-reports"), "crash-" + (new SimpleDateFormat("yyyy-MM-dd_HH.mm.ss")).format(new Date()) + "-server.txt");
