...
public class RecipeManager extends JsonReloadListener {
    ...
    public static void setRecipeFallback(Supplier<Collection<IRecipe<?>>> loader) {
        recipeFallback = loader;
    }

    public static Supplier<Collection<IRecipe<?>>> getRecipeFallback() {
    ...
    protected void apply(Map<ResourceLocation, JsonObject> splashList, IResourceManager resourceManagerIn, IProfiler profilerIn) {
        ...
        LOGGER.info("Loaded {} recipes", (int) this.recipes.values().stream().mapToInt(Map::size).sum());
    }
