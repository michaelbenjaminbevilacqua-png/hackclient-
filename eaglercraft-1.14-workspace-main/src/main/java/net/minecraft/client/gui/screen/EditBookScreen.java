...
public class EditBookScreen extends Screen {
   ...
   private void sendBookToServer(boolean p_214198_1_) {
      if (this.field_214234_c) {
         ...
         this.mc.getConnection().sendPacket(new CEditBookPacket(this.book, p_214198_1_, this.hand));
      }
   }
   ...
   private boolean func_214230_b(int p_214230_1_, int p_214230_2_, int p_214230_3_) {
      ...
      if (Screen.isSelectAll(p_214230_1_)) {
         ...
         this.mc.keyboardListener.setClipboardString(this.func_214231_i());
         return true;
      } else if (Screen.isPaste(p_214230_1_)) {
         this.func_214202_k(this.func_214219_a(TextFormatting.getTextWithoutFormattingCodes(this.mc.keyboardListener.getClipboardString().replaceAll("\\r", ""))));
         this.field_214241_j = this.field_214240_i;
         return true;
   ...
   public void render(int p_render_1_, int p_render_2_, float p_render_3_) {
      ...
      this.mc.getTextureManager().bindTexture(ReadBookScreen.field_214167_b);
      int i = (this.width - 192) / 2;
      int j = 2;
