...
public abstract class AbstractCommandBlockScreen extends Screen {
    ...
    private void func_209107_u() {
        ...
        this.suggestionList = null;
        if (this.mc.gameSettings.autoSuggestCommands) {
            this.func_209109_s();
        }
    ...
    class SuggestionsList {
        ...
        public boolean mouseScrolled(double amount) {
            int i = (int) (AbstractCommandBlockScreen.this.mc.mouseHelper.getMouseX() * (double) AbstractCommandBlockScreen.this.mc.mainWindow.getScaledWidth() / (double) AbstractCommandBlockScreen.this.mc.mainWindow.getWidth());
            int j = (int) (AbstractCommandBlockScreen.this.mc.mouseHelper.getMouseY() * (double) AbstractCommandBlockScreen.this.mc.mainWindow.getScaledHeight() / (double) AbstractCommandBlockScreen.this.mc.mainWindow.getHeight());
