...
public class DisconnectedScreen extends Screen {
    ...
    public static DisconnectedScreen createRateLimitKick(Screen parent) {
        return new DisconnectedScreen(parent, "disconnect.timeout", new net.minecraft.util.text.TranslationTextComponent("disconnect.timeout"));
    }
