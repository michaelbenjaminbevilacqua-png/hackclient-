...
public class EditMinecartCommandBlockScreen extends AbstractCommandBlockScreen {
    ...
    protected void func_195235_a(CommandBlockLogic p_195235_1_) {
        if (p_195235_1_ instanceof MinecartCommandBlockEntity.MinecartCommandLogic) {
            ...
            this.mc.getConnection().sendPacket(new CUpdateMinecartCommandBlockPacket(minecartcommandblockentity$minecartcommandlogic.getMinecart().getEntityId(), this.commandTextField.getText(), p_195235_1_.shouldTrackOutput()));
        }
