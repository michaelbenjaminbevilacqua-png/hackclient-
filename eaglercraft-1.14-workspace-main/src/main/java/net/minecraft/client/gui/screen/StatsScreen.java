...
public class StatsScreen extends Screen implements IProgressMeter {
    ...
    public void func_213110_a(ExtendedList<?> p_213110_1_) {
    ...
    class StatsList extends ExtendedList<StatsScreen.StatsList.Entry> {
        ...
        protected void func_200207_a(ITextComponent p_200207_1_, int p_200207_2_, int p_200207_3_) {
            if (p_200207_1_ != null) {
        ...
        class Entry extends ExtendedList.AbstractListEntry<StatsScreen.StatsList.Entry> {
            ...
            protected void func_214406_a(Stat<?> p_214406_1_, int p_214406_2_, int p_214406_3_, boolean p_214406_4_) {
