...
public class OptionsRowList extends AbstractOptionList<OptionsRowList.Row> {
    ...
    public void func_214334_a(AbstractOption p_214334_1_, AbstractOption p_214334_2_) {
    ...
    public static class Row extends AbstractOptionList.Entry<OptionsRowList.Row> {
        ...
        public static OptionsRowList.Row create(GameSettings settings, int guiWidth, AbstractOption leftOption, AbstractOption rightOption) {
