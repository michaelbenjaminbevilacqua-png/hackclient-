...
public class TextFieldWidget extends Widget implements IRenderable, IGuiEventListener {
    ...
    public TextFieldWidget(FontRenderer fontIn, int xIn, int yIn, int widthIn, int heightIn, TextFieldWidget p_i51138_6_, String msg) {
    ...
    public void setSuggestion(String p_195612_1_) {
