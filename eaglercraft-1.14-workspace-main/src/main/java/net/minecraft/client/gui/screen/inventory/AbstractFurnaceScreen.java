...
public abstract class AbstractFurnaceScreen<T extends AbstractFurnaceContainer> extends ContainerScreen<T> implements IRecipeShownListener {
    ...
    public void init() {
        ...
        this.field_214088_k.func_201520_a(this.width, this.height, this.mc, this.field_214090_m, this.container);
    ...
    protected void drawGuiContainerBackgroundLayer(float partialTicks, int mouseX, int mouseY) {
        ...
        this.mc.getTextureManager().bindTexture(this.field_214091_n);
        int i = this.guiLeft;
        int j = this.guiTop;
