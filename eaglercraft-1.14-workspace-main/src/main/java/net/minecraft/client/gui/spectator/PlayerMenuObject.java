...
public class PlayerMenuObject implements ISpectatorMenuObject {
   ...
   public PlayerMenuObject(GameProfile profileIn) {
      ...
      if (minecraft.player != null && isSelfProfile(profileIn, minecraft)) {
         this.resourceLocation = net.lax1dude.eaglercraft.profile.EaglerProfile.getActiveSkinResourceLocation();
      } else {
   ...
   private static boolean isSelfProfile(GameProfile profile, Minecraft minecraft) {
      if (profile.getId() != null && profile.getId().equals(minecraft.player.getUniqueID())) {
         return true;
      }
      if (profile.getName() != null && !profile.getName().isEmpty()) {
         ...
         if (profile.getName().equals(net.lax1dude.eaglercraft.profile.EaglerProfile.username)) {
            return true;
         }
      }
      return false;
