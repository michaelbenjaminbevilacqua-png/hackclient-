...
public class ControlsScreen extends Screen {
    ...
    protected void init() {
        this.addButton(new Button(this.width / 2 - 155, 18, 150, 20, I18n.format("options.mouse_settings"), (p_213126_1_) -> {
            this.mc.displayGuiScreen(new MouseSettingsScreen(this));
        }));
        this.addButton(AbstractOption.AUTO_JUMP.createWidget(this.mc.gameSettings, this.width / 2 - 155 + 160, 18, 150));
