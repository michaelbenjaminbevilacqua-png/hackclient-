...
public class OptionsSoundsScreen extends Screen {
    ...
    protected void init() {
        ...
        this.addButton(new OptionButton(j, k + 24 * (i >> 1), 150, 20, AbstractOption.SHOW_SUBTITLES, AbstractOption.SHOW_SUBTITLES.func_216743_c(this.game_settings_4), (p_213105_1_) -> {
            AbstractOption.SHOW_SUBTITLES.func_216740_a(this.mc.gameSettings);
            p_213105_1_.setMessage(AbstractOption.SHOW_SUBTITLES.func_216743_c(this.mc.gameSettings));
