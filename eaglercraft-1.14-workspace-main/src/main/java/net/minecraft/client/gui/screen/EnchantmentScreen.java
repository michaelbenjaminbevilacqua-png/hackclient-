...
public class EnchantmentScreen extends ContainerScreen<EnchantmentContainer> {
    ...
    protected void drawGuiContainerBackgroundLayer(float partialTicks, int mouseX, int mouseY) {
        ...
        GlStateManager.multMatrix(Matrix4f.perspective(85.0D, (float) Minecraft.getInstance().mainWindow.getFramebufferWidth() / (float) Minecraft.getInstance().mainWindow.getFramebufferHeight(), 0.05F, 10.0F).getElements());
        float f = 1.0F;
    ...
    public void render(int p_render_1_, int p_render_2_, float p_render_3_) {
        p_render_3_ = this.mc.getRenderPartialTicks();
