...
public class CartographyTableScreen extends ContainerScreen<CartographyContainer> {
    ...
    protected void drawGuiContainerBackgroundLayer(float partialTicks, int mouseX, int mouseY) {
        ...
        this.mc.getTextureManager().bindTexture(field_214109_k);
        int i = this.guiLeft;
        int j = this.guiTop;
        ...
        if (itemstack.getItem() == Items.FILLED_MAP) {
            mapdata = FilledMapItem.func_219994_a(itemstack, this.mc.world);
            if (mapdata != null) {
                if (mapdata.locked) {
                    flag3 = true;
                    if (flag1 || flag2) {
    ...
    private void func_214107_a(MapData p_214107_1_, boolean p_214107_2_, boolean p_214107_3_, boolean p_214107_4_, boolean p_214107_5_) {
        int i = this.guiLeft;
        int j = this.guiTop;
    ...
    private void func_214108_a(MapData p_214108_1_, int p_214108_2_, int p_214108_3_, float p_214108_4_) {
        if (p_214108_1_ != null) {
            GlStateManager.pushMatrix();
            GlStateManager.translatef((float) p_214108_2_, (float) p_214108_3_, 1.0F);
            GlStateManager.scalef(p_214108_4_, p_214108_4_, 1.0F);
            this.mc.gameRenderer.getMapItemRenderer().renderMap(p_214108_1_, true);
            GlStateManager.popMatrix();
        }
