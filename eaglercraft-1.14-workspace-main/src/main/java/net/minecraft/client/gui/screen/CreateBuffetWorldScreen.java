...
public class CreateBuffetWorldScreen extends Screen {
    ...
    class BiomeList extends ExtendedList<CreateBuffetWorldScreen.BiomeList.BiomeEntry> {
        private BiomeList() {
            super(CreateBuffetWorldScreen.this.mc, CreateBuffetWorldScreen.this.width, CreateBuffetWorldScreen.this.height, 80, CreateBuffetWorldScreen.this.height - 37, 16);
        ...
        public void setSelected(CreateBuffetWorldScreen.BiomeList.BiomeEntry p_setSelected_1_) {
