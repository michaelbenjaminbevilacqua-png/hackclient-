...
public class CommandBlockScreen extends AbstractCommandBlockScreen {
   ...
   protected void func_195235_a(CommandBlockLogic p_195235_1_) {
      this.mc.getConnection().sendPacket(new CUpdateCommandBlockPacket(new BlockPos(p_195235_1_.getPositionVector()), this.commandTextField.getText(), this.commandBlockMode, p_195235_1_.shouldTrackOutput(), this.conditional, this.automatic));
   }
