...
public class CreateWorldScreen extends Screen {
    ...
    protected void init() {
        ...
        this.btnCustomizeType = this.addButton(new Button(this.width / 2 + 5, 120, 150, 20, I18n.format("selectWorld.customizeType"), (p_214314_1_) -> {
            if (WorldType.WORLD_TYPES[this.selectedIndex] == WorldType.FLAT) {
                this.mc.displayGuiScreen(new CreateFlatWorldScreen(this, this.chunkProviderSettingsJson));
            }

            if (WorldType.WORLD_TYPES[this.selectedIndex] == WorldType.BUFFET) {
                this.mc.displayGuiScreen(new CreateBuffetWorldScreen(this, this.chunkProviderSettingsJson));
            }
    ...
    private void createWorld() {
        ...
        if (!this.alreadyGenerated) {
            ...
            worldsettings.setGeneratorOptions(new com.google.gson.JsonObject());
    ...
    private static final String[] DISALLOWED_FILENAMES = new String[]{"CON", "PRN", "AUX", "NUL", "COM1", "COM2",
            "COM3", "COM4", "COM5", "COM6", "COM7", "COM8", "COM9", "LPT1", "LPT2", "LPT3", "LPT4", "LPT5", "LPT6",
            "LPT7", "LPT8", "LPT9"};

    public static String getUncollidingSaveDirName(SaveFormat saveLoader, String name) {
