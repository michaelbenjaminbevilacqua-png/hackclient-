        ...
        for (int j = 0; j < i; ++j) {
            ...
            if (l >= this.y0 && k <= this.y1) {
                ...
                if (this.renderSelection && this.isSelectedItem(j)) {
                    ...
                    bufferbuilder.pos((double) l1, (double) (i1 - 1), 0.0D).endVertex();
                    bufferbuilder.pos((double) i2, (double) (i1 - 1), 0.0D).endVertex();
                    ...
                    bufferbuilder.pos((double) i2, (double) (i1 + j1 + 1), 0.0D).endVertex();
                    bufferbuilder.pos((double) l1, (double) (i1 + j1 + 1), 0.0D).endVertex();
