...
public class LoomScreen extends ContainerScreen<LoomContainer> {
   ...
   protected void drawGuiContainerBackgroundLayer(float partialTicks, int mouseX, int mouseY) {
      ...
      this.mc.getTextureManager().bindTexture(field_214113_k);
      int i = this.guiLeft;
      int j = this.guiTop;
      ...
      if (this.field_214118_p != null && !this.field_214125_w) {
         this.mc.getTextureManager().bindTexture(this.field_214118_p);
      ...
      if (this.field_214123_u) {
         ...
         for(int k1 = this.field_214128_z; k1 < j1 && k1 < this.field_214122_t.length - 5; ++k1) {
            ...
            if (this.field_214122_t[k1] != null) {
               this.mc.getTextureManager().bindTexture(this.field_214122_t[k1]);
         ...
         if (this.field_214122_t[j3] != null) {
            this.mc.getTextureManager().bindTexture(this.field_214122_t[j3]);
