...
public class AddServerScreen extends Screen {
    ...
    protected void init() {
        ...
        String displayIP = this.serverData.serverIP;
        if (displayIP != null && displayIP.startsWith("java://")) {
            this.isWisp = true;
            displayIP = displayIP.substring(7);
        }
        this.field_146308_f.setText(displayIP);
        ...
        this.addButton(new Button(this.width / 2 - 100, this.height / 4 + 144, 200, 20, I18n.format("gui.cancel"), (p_213029_1_) -> {
    ...
    private void func_195172_h() {
        ...
        String ip = this.field_146308_f.getText();
        this.serverData.serverIP = ip;
