...
public abstract class AbstractOption {
    ...
    public static final BooleanOption SHOW_FPS = new BooleanOption("Show FPS", (p_216619_0_) -> {
        return p_216619_0_.showFps;
    }, (p_216621_0_, p_216621_1_) -> {
        p_216621_0_.showFps = p_216621_1_;
    });
    public static final BooleanOption SHOW_XYZ = new BooleanOption("Show XYZ", (p_216619_0_) -> {
        return p_216619_0_.showXYZ;
    }, (p_216621_0_, p_216621_1_) -> {
    ...
    public static final SliderPercentageOption UPDATES_PER_FRAME = new SliderPercentageOption("Chunk Updates", 1.0D, 4.0D, 1.0F, (p_216672_0_) -> {
        ...
        p_216608_0_.updatesPerFrame = p_216608_1_.intValue();
    }, (p_216645_0_, p_216645_1_) -> {
        double d0 = p_216645_1_.get(p_216645_0_);
    ...
    public static final BooleanOption FAST_ENTITY_RENDER = new BooleanOption("Fast Entity Render", (p_216619_0_) -> {
        ...
        p_216621_0_.fastEntityRender = p_216621_1_;
    });
    public static final BooleanOption FAST_TILEENTITY_RENDER = new BooleanOption("Fast TileEntity Render", (p_216619_0_) -> {
        return p_216619_0_.fastTileEntityRender;
    }, (p_216621_0_, p_216621_1_) -> {
    ...
    public static final BooleanOption CHUNK_FIX = new BooleanOption("Chunk Lag Fix", (p_216619_0_) -> {
        ...
        p_216621_0_.chunkFix = p_216621_1_;
    });
