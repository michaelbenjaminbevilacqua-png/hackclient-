...
public class GameConfiguration {
   ...
   public static class FolderInformation {
      ...
      public final VFile2 resourcePacksDir;
      public final VFile2 assetsDir;
      public final String assetIndex;

      public FolderInformation(VFile2 mcDataDirIn, VFile2 resourcePacksDirIn, VFile2 assetsDirIn,  String assetIndexIn) {
      ...
      public ResourceIndex getAssetsIndex() {
         return (ResourceIndex)(this.assetIndex == null ? new FolderResourceIndex(new java.io.File(this.assetsDir.getPath())) : new ResourceIndex(this.assetsDir, this.assetIndex));
      }
   }
