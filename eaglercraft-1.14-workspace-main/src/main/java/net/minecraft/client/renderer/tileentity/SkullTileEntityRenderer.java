...
public class SkullTileEntityRenderer extends TileEntityRenderer<SkullTileEntity> {
   ...
   public void render(float x, float y, float z,  Direction facing, float rotationIn, SkullBlock.ISkullType type,  GameProfile playerProfile, int destroyStage, float animationProgress) {
   ...
   private ResourceLocation func_199356_a(SkullBlock.ISkullType p_199356_1_,  GameProfile p_199356_2_) {
      ...
      if (p_199356_1_ == SkullBlock.Types.PLAYER && p_199356_2_ != null) {
         ...
         if (map != null && map.containsKey(Type.SKIN)) {
            ...
            if (minecraft.player != null &&
                  (p_199356_2_.getId() != null && p_199356_2_.getId().equals(minecraft.player.getUniqueID()) ||
                   p_199356_2_.getName() != null && p_199356_2_.getName().equals(minecraft.player.getName().getString()))) {
               resourcelocation = net.lax1dude.eaglercraft.profile.EaglerProfile.getActiveSkinResourceLocation();
            } else {
               resourcelocation = DefaultPlayerSkin.getDefaultSkin(PlayerEntity.getUUID(p_199356_2_));
            }
         }
      } else if (p_199356_1_ == SkullBlock.Types.PLAYER && p_199356_2_ == null) {
         resourcelocation = net.lax1dude.eaglercraft.profile.EaglerProfile.getActiveSkinResourceLocation();
      }
