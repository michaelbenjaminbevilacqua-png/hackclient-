...
public class PointOfInterestDebugRenderer implements DebugRenderer.IDebugRenderer {
   ...
   private final Map<EaglercraftUUID, PointOfInterestDebugRenderer.BrainInfo> field_217715_e = Maps.newHashMap();
   private EaglercraftUUID field_217716_f;
   ...
   private Collection<EaglercraftUUID> func_217697_c(BlockPos p_217697_1_) {
   ...
   public static class BrainInfo {
      public final EaglercraftUUID field_217747_a;
      ...
      public BrainInfo(EaglercraftUUID p_i51529_1_, int p_i51529_2_, String p_i51529_3_, String p_i51529_4_, int p_i51529_5_, IPosition p_i51529_6_, String p_i51529_7_,  Path p_i51529_8_, boolean p_i51529_9_) {
      ...
      public EaglercraftUUID func_217746_a() {
