...
public class RenderSkyboxCube {
    ...
    public void render(Minecraft mc, float pitch, float yaw, float alpha) {
        ...
        GlStateManager.multMatrix(Matrix4f.perspective(85.0D, (float) mc.mainWindow.getFramebufferWidth() / (float) mc.mainWindow.getFramebufferHeight(), 0.05F, 10.0F).getElements());
