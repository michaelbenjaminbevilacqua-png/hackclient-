...
public class ItemRenderer implements IResourceManagerReloadListener {
    ...
    public IBakedModel getItemModelWithOverrides(ItemStack stack, World worldIn, LivingEntity entitylivingbaseIn) {
        IBakedModel ibakedmodel = this.itemModelMesher.getItemModel(stack);
    ...
    private IBakedModel getModelWithOverrides(IBakedModel model, ItemStack stack, World worldIn, LivingEntity entityIn) {
