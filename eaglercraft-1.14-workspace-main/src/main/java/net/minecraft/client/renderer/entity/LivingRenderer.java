   ...
   protected boolean setBrightness(T entitylivingbaseIn, float partialTicks, boolean combineTextures) {
      ...
      if (!flag && !flag1) {
         ...
         if (flag1) {
            ...
            constR = (float)(i >> 16 & 255) / 255.0F;
            constG = (float)(i >> 8 & 255) / 255.0F;
            constB = (float)(i & 255) / 255.0F;
            factor = 1.0F - f1;
         }

         GlStateManager.setShaderColorOverlay(1.0F - factor, 1.0F - factor, 1.0F - factor, constR * factor, constG * factor, constB * factor);
         return true;
      }
   }
