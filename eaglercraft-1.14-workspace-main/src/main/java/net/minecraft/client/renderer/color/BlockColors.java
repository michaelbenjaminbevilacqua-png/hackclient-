...
import static net.lax1dude.eaglercraft.opengl.ImageData.swapRB;
...
public class BlockColors {
    ...
    public static BlockColors init() {
        ...
        blockcolors.register((p_210234_0_, p_210234_1_, p_210234_2_, p_210234_3_) -> {
            int color = p_210234_1_ != null && p_210234_2_ != null ? BiomeColors.getGrassColor(p_210234_1_, p_210234_0_.get(ShearableDoublePlantBlock.field_208063_b) == DoubleBlockHalf.UPPER ? p_210234_2_.down() : p_210234_2_) : -1;
            return swapRB(color);
        ...
        blockcolors.register((p_210225_0_, p_210225_1_, p_210225_2_, p_210225_3_) -> {
            int color = p_210225_1_ != null && p_210225_2_ != null ? BiomeColors.getGrassColor(p_210225_1_, p_210225_2_) : GrassColors.get(0.5D, 1.0D);
            return swapRB(color);
        ...
        blockcolors.register((p_210227_0_, p_210227_1_, p_210227_2_, p_210227_3_) -> {
            return swapRB(FoliageColors.getSpruce());
        }, Blocks.SPRUCE_LEAVES);

        blockcolors.register((p_210232_0_, p_210232_1_, p_210232_2_, p_210232_3_) -> {
            return swapRB(FoliageColors.getBirch());
        }, Blocks.BIRCH_LEAVES);

        blockcolors.register((p_210229_0_, p_210229_1_, p_210229_2_, p_210229_3_) -> {
            int color = p_210229_1_ != null && p_210229_2_ != null ? BiomeColors.getFoliageColor(p_210229_1_, p_210229_2_) : FoliageColors.getDefault();
            return swapRB(color);
        ...
        blockcolors.register((p_210230_0_, p_210230_1_, p_210230_2_, p_210230_3_) -> {
            int color = p_210230_1_ != null && p_210230_2_ != null ? BiomeColors.getGrassColor(p_210230_1_, p_210230_2_) : -1;
            return swapRB(color);
        }, Blocks.SUGAR_CANE);
    ...
    public int getColor(BlockState p_216860_1_, IEnviromentBlockReader p_216860_2_, BlockPos p_216860_3_, int p_216860_4_) {
