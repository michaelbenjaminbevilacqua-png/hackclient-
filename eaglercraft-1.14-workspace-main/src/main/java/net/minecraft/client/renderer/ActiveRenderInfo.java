...
public class ActiveRenderInfo {
   ...
   public void update(IBlockReader worldIn, Entity renderViewEntity, boolean thirdPersonIn, boolean thirdPersonReverseIn, float partialTicks) {
      ...
      this.thirdPersonReverse = thirdPersonReverseIn;
            this.setDirection(net.eaglerclient.mods.impl.FreeLookMod.getCameraYaw(renderViewEntity.getYaw(partialTicks)),
               net.eaglerclient.mods.impl.FreeLookMod.getCameraPitch(renderViewEntity.getPitch(partialTicks)));
