...
public class FaceBakery {
   ...
   public BakedQuad func_217648_a(Vector3f p_217648_1_, Vector3f p_217648_2_, BlockPartFace p_217648_3_, TextureAtlasSprite p_217648_4_, Direction p_217648_5_, ISprite p_217648_6_,  BlockPartRotation p_217648_7_, boolean p_217648_8_) {
   ...
   private int[] makeQuadVertexData(BlockFaceUV uvs, TextureAtlasSprite sprite, Direction orientation, float[] posDiv16, ModelRotation rotationIn,  BlockPartRotation partRotation, boolean shade) {
      int[] aint = new int[28];
   ...
   private void fillVertexData(int[] vertexData, int vertexIndex, Direction facing, BlockFaceUV blockFaceUVIn, float[] posDiv16, TextureAtlasSprite sprite, ModelRotation rotationIn,  BlockPartRotation partRotation, boolean shade) {
   ...
   private void rotatePart(Vector3f vec,  BlockPartRotation partRotation) {
