...
public class BreakingParticle extends SpriteTexturedParticle {
   ...
   protected float getMinU() {
      return this.sprite != null ? this.sprite.getInterpolatedU((double)((this.field_217571_C + 1.0F) / 4.0F * 16.0F)) : 0.0F;
   }

   protected float getMaxU() {
      return this.sprite != null ? this.sprite.getInterpolatedU((double)(this.field_217571_C / 4.0F * 16.0F)) : 1.0F;
   }

   protected float getMinV() {
      return this.sprite != null ? this.sprite.getInterpolatedV((double)(this.field_217572_F / 4.0F * 16.0F)) : 0.0F;
   }

   protected float getMaxV() {
      return this.sprite != null ? this.sprite.getInterpolatedV((double)((this.field_217572_F + 1.0F) / 4.0F * 16.0F)) : 1.0F;
   }
