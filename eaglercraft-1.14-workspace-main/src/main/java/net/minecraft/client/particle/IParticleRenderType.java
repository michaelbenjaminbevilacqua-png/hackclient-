...
public interface IParticleRenderType {
   static void setupParticleTextureState() {
      net.lax1dude.eaglercraft.opengl.GlStateManager.disableTexGen();

      net.lax1dude.eaglercraft.opengl.GlStateManager.setActiveTexture(net.lax1dude.eaglercraft.opengl.OpenGlHelper.lightmapTexUnit);
   ...
   IParticleRenderType TERRAIN_SHEET = new IParticleRenderType() {
      public void beginRender(BufferBuilder p_217600_1_, TextureManager p_217600_2_) {
         ...
         IParticleRenderType.setupParticleTextureState();
