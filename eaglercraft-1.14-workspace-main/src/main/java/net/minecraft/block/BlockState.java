...
public class BlockState extends StateHolder<Block, BlockState> implements IStateHolder<BlockState> {
   ...
   public boolean func_224755_d(IBlockReader p_224755_1_, BlockPos p_224755_2_, Direction p_224755_3_) {
      BlockState.Cache blockstate$cache = this.cache;
      if (blockstate$cache != null) {
         return blockstate$cache.field_225493_i[p_224755_3_.ordinal()];
      }

      return Block.hasSolidSide(this, p_224755_1_, p_224755_2_, p_224755_3_);
   }
