...
public class Block implements IItemProvider {
    ...
    private static final LoadingCache<VoxelShape, Boolean> OPAQUE_CACHE = new LoadingCache<>(new com.google.common.cache.CacheProvider<VoxelShape, Boolean>() {
        public Boolean create(VoxelShape p_load_1_) {
    ...
    public static List<ItemStack> getDrops(BlockState state, ServerWorld worldIn, BlockPos pos, TileEntity tileEntityIn) {
    ...
    public static List<ItemStack> getDrops(BlockState state, ServerWorld worldIn, BlockPos pos, TileEntity tileEntityIn, Entity entityIn, ItemStack stack) {
    ...
    public static void spawnDrops(BlockState state, World worldIn, BlockPos pos, TileEntity tileEntityIn) {
        if (worldIn instanceof ServerWorld) {
    ...
    public static void spawnDrops(BlockState state, World worldIn, BlockPos pos, TileEntity tileEntityIn, Entity entityIn, ItemStack stack) {
        if (worldIn instanceof ServerWorld) {
