...
public class BlockPattern {
    ...
    public static LoadingCache<BlockPos, CachedBlockInfo> createLoadingCache(IWorldReader worldIn, boolean forceLoadIn) {
        return new LoadingCache<>(new BlockPattern.CacheLoader(worldIn, forceLoadIn));
    }
    ...
    static class CacheLoader implements com.google.common.cache.CacheProvider<BlockPos, CachedBlockInfo> {
        ...
        public CachedBlockInfo create(BlockPos p_load_1_) {
