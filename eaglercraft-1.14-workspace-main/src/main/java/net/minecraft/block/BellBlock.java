...
public class BellBlock extends ContainerBlock {
    ...
    public boolean ring(World worldIn, BlockState state, TileEntity p_220130_3_, BlockRayTraceResult p_220130_4_, PlayerEntity ringingPlayer, boolean p_220130_6_) {
