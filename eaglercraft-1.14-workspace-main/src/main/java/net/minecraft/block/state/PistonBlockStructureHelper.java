      ...
      if (blockstate.isAir()) {
         ...
         if (i + this.toMove.size() > 12) {
            ...
            while(block == Blocks.SLIME_BLOCK) {
               ...
               if (blockstate.isAir() || !PistonBlock.canPush(blockstate, this.world, blockpos, this.moveDirection, false, this.moveDirection.getOpposite()) || blockpos.equals(this.pistonPos)) {
                  break;
               }
