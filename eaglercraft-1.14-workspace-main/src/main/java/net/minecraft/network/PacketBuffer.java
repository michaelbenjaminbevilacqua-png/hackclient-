...
import net.lax1dude.eaglercraft.DecoderException;
import net.lax1dude.eaglercraft.EaglercraftUUID;
import net.lax1dude.eaglercraft.EncoderException;
...
public class PacketBuffer extends ByteBuf {
    ...
    public PacketBuffer writeCompoundTag(CompoundNBT nbt) {
        if (nbt == null) {
            this.writeByte(0);
        } else {
            try {
    ...
    public ResourceLocation readResourceLocation() {
        String str = this.readString(32767);
        if (str.equals("EAG|1.8") || str.equals("legacy:eag|1.8")) return new ResourceLocation("legacy:eag_1.8");
        if (str.equals("EAG|Skins-1.8") || str.equals("legacy:eag|skins-1.8"))
            return new ResourceLocation("legacy:eag_skins_1.8");
        if (str.equals("EAG|Capes-1.8") || str.equals("legacy:eag|capes-1.8"))
            return new ResourceLocation("legacy:eag_capes_1.8");
        if (str.equals("EAG|Voice-1.8") || str.equals("legacy:eag|voice-1.8"))
            return new ResourceLocation("legacy:eag_voice_1.8");
        if (str.equals("EAG|UpdateCert-1.8") || str.equals("legacy:eag|updatecert-1.8"))
            return new ResourceLocation("legacy:eag_updatecert_1.8");
        if (str.equals("EAG|FNAWSEn-1.8") || str.equals("legacy:eag|fnawsen-1.8"))
            return new ResourceLocation("legacy:eag_fnawsen_1.8");
        return new ResourceLocation(str);
    }

    public PacketBuffer writeResourceLocation(ResourceLocation resourceLocationIn) {
        String str = resourceLocationIn.toString();
        if (str.equals("legacy:eag_1.8")) str = "legacy:eag|1.8";
        else if (str.equals("legacy:eag_skins_1.8")) str = "legacy:eag|skins-1.8";
        else if (str.equals("legacy:eag_capes_1.8")) str = "legacy:eag|capes-1.8";
        else if (str.equals("legacy:eag_voice_1.8")) str = "legacy:eag|voice-1.8";
        else if (str.equals("legacy:eag_updatecert_1.8")) str = "legacy:eag|updatecert-1.8";
        else if (str.equals("legacy:eag_fnawsen_1.8")) str = "legacy:eag|fnawsen-1.8";
