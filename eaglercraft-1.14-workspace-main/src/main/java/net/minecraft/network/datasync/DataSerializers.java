...
public class DataSerializers {
   ...
   public static final IDataSerializer<Optional<EaglercraftUUID>> OPTIONAL_UNIQUE_ID = new IDataSerializer<Optional<EaglercraftUUID>>() {
      ...
      public Optional<EaglercraftUUID> read(PacketBuffer buf) {
