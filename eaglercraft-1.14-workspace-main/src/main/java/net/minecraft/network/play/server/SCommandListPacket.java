...
public class SCommandListPacket implements IPacket<IClientPlayNetHandler> {
    ...
    public void readPacketData(PacketBuffer buf) throws IOException {
        ...
        java.util.List<SCommandListPacket.Entry> deque = new java.util.ArrayList<>(ascommandlistpacket$entry.length);
    ...
    private ArgumentBuilder<ISuggestionProvider, ?> readArgumentBuilder(PacketBuffer buf, byte flags) {
        ...
        if (i == 2) {
            ...
            ResourceLocation suggestionId = null;
            if ((flags & 16) != 0) {
                suggestionId = buf.readResourceLocation();
            }
            ...
            if (argumenttype == null) {
                ...
                if (suggestionId != null) {
                    requiredargumentbuilder.suggests(SuggestionProviders.get(suggestionId));
                }
    ...
    static class Entry {
        ...
        private Entry(ArgumentBuilder<ISuggestionProvider, ?> argBuilderIn, byte flagsIn, int redirectTargetIn, int[] childrenIn) {
