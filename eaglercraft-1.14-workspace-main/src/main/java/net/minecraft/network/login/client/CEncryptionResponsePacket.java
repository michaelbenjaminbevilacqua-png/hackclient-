...
public class CEncryptionResponsePacket implements IPacket<IServerLoginNetHandler> {
   ...
   @OnlyIn(Dist.CLIENT)
   public CEncryptionResponsePacket(Object secret, Object key, byte[] verifyToken) {
      this.secretKeyEncrypted = CryptManager.encryptData(key, new byte[0]);
   ...
   public Object getSecretKey(Object key) {
      return CryptManager.decryptSharedKey(key, this.secretKeyEncrypted);
   }

   public byte[] getVerifyToken(Object key) {
