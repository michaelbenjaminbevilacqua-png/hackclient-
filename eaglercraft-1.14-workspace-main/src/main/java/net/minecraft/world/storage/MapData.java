...
public class MapData extends WorldSavedData {
    ...
    private void updateDecorations(MapDecoration.Type type, IWorld worldIn, String decorationName, double worldX, double worldZ, double rotationIn, ITextComponent p_191095_10_) {
        int i = 1 << this.scale;
