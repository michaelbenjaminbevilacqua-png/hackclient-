...
public class AnvilSaveConverter {
    ...
    static boolean func_215792_a(VFile2 p_215792_0_, DataFixer p_215792_1_, String p_215792_2_, IProgressUpdate p_215792_3_) {
        p_215792_3_.setLoadingProgress(0);
        List<VFile2> list = Lists.newArrayList();
        List<VFile2> list1 = Lists.newArrayList();
        List<VFile2> list2 = Lists.newArrayList();
        VFile2 file1 = new VFile2(p_215792_0_, p_215792_2_);
        VFile2 file2 = DimensionType.THE_NETHER.getDirectory(file1);
        VFile2 file3 = DimensionType.THE_END.getDirectory(file1);
        ...
        func_215794_a(new VFile2(file1, "region"), list, biomeprovider, 0, i, p_215792_3_);
        func_215794_a(new VFile2(file2, "region"), list1, biomeprovidertype.create(biomeprovidertype.createSettings().setBiome(Biomes.NETHER)), list.size(), i, p_215792_3_);
        func_215794_a(new VFile2(file3, "region"), list2, biomeprovidertype.create(biomeprovidertype.createSettings().setBiome(Biomes.THE_END)), list.size() + list1.size(), i, p_215792_3_);
    ...
    private static void func_215790_a(VFile2 p_215790_0_, String p_215790_1_) {
        VFile2 file1 = new VFile2(p_215790_0_, p_215790_1_);
        if (!file1.exists()) {
            ...
            if (!file2.exists()) {
                ...
                VFile2 file3 = new VFile2(file1, "level.dat_mcr");
    ...
    private static void func_215794_a(VFile2 p_215794_0_, Iterable<VFile2> p_215794_1_, BiomeProvider p_215794_2_, int p_215794_3_, int p_215794_4_, IProgressUpdate p_215794_5_) {
        for (VFile2 file1 : p_215794_1_) {
    ...
    private static void func_215793_a(VFile2 p_215793_0_, VFile2 p_215793_1_, BiomeProvider p_215793_2_, int p_215793_3_, int p_215793_4_, IProgressUpdate p_215793_5_) {
        String s = p_215793_1_.getName();

        try (
                RegionFile regionfile = new RegionFile(p_215793_1_);
                RegionFile regionfile1 = new RegionFile(new VFile2(p_215793_0_, (new StringBuilder()).append(s.substring(0, s.length() - ".mcr".length())).append(".mca").toString()));
        ) {
            for (int i = 0; i < 32; ++i) {
                for (int j = 0; j < 32; ++j) {
    ...
    private static void func_215789_a(VFile2 p_215789_0_, Collection<VFile2> p_215789_1_) {
        VFile2 file1 = new VFile2(p_215789_0_, "region");
        net.lax1dude.eaglercraft.internal.vfs2.VFile2[] afile = new net.lax1dude.eaglercraft.internal.vfs2.VFile2[0];
        if (afile != null) {
