...
public class SetAttributes extends LootFunction {
   ...
   static class Modifier {
      ...
      private Modifier(String p_i50835_1_, String p_i50835_2_, AttributeModifier.Operation p_i50835_3_, RandomValueRange p_i50835_4_, EquipmentSlotType[] p_i50835_5_,  EaglercraftUUID p_i50835_6_) {
      ...
      public static SetAttributes.Modifier deserialize(JsonObject jsonObj, JsonDeserializationContext context) {
         ...
         if (jsonObj.has("id")) {
            ...
            try {
               ...
               throw new JsonSyntaxException("Invalid attribute modifier id '" + s2 + "' (must be EaglercraftUUID format, with dashes)");
            }
         }
