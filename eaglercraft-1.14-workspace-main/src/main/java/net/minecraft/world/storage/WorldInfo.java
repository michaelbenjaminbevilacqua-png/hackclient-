...
public class WorldInfo {
   ...
   private EaglercraftUUID wanderingTraderId;
   ...
   public WorldInfo(CompoundNBT nbt, DataFixer dataFixer, int dataVersionIn,  CompoundNBT playerDataIn) {
      ...
      if (nbt.contains("WanderingTraderId", 8)) {
         this.wanderingTraderId = EaglercraftUUID.fromString(nbt.getString("WanderingTraderId"));
      }
   ...
   public CompoundNBT cloneNBTCompound( CompoundNBT nbt) {
      this.fixPlayerData();
      if (nbt == null) {
         nbt = this.playerData;
      }
   ...
   public void setCustomBossEvents( CompoundNBT p_201356_1_) {
   ...
   public void setWanderingTraderId(EaglercraftUUID p_215761_1_) {
