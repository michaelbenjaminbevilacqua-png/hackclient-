...
public class LootPool {
    ...
    public static class Serializer implements JsonDeserializer<LootPool>, JsonSerializer<LootPool> {
        public LootPool deserialize(JsonElement p_deserialize_1_, Type p_deserialize_2_, JsonDeserializationContext p_deserialize_3_) throws JsonParseException {
            ...
            LootEntry[] alootentry = JSONUtils.deserializeArray(jsonobject, "entries", p_deserialize_3_, LootEntry.class, LootEntry[]::new);
            ILootCondition[] ailootcondition = JSONUtils.deserializeArray(jsonobject, "conditions", new ILootCondition[0], p_deserialize_3_, ILootCondition.class, ILootCondition[]::new);
            ILootFunction[] ailootfunction = JSONUtils.deserializeArray(jsonobject, "functions", new ILootFunction[0], p_deserialize_3_, ILootFunction.class, ILootFunction[]::new);
