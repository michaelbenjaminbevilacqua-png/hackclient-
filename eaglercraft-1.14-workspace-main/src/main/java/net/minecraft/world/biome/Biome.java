...
public abstract class Biome {
    ...
    private final ThreadLocal<Long2FloatLinkedOpenHashMap> field_225488_v = new ThreadLocal<Long2FloatLinkedOpenHashMap>() {
        @Override
        protected Long2FloatLinkedOpenHashMap initialValue() {
            return Util.make(() -> {
    ...
    public static class Builder {
        ...
        public Biome.Builder parent(String parentIn) {
