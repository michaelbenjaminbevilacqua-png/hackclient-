...
public abstract class World implements IEnviromentBlockReader, IWorld, AutoCloseable {
    ...
    public abstract void playSound(PlayerEntity player, double x, double y, double z, SoundEvent soundIn, SoundCategory category, float volume, float pitch);

    public abstract void playMovingSound(PlayerEntity p_217384_1_, Entity p_217384_2_, SoundEvent p_217384_3_, SoundCategory p_217384_4_, float p_217384_5_, float p_217384_6_);
    ...
    public Vec3d getSkyColor(BlockPos p_217382_1_, float p_217382_2_) {
        ...
        f1 = MathHelper.clamp(f1, 0.05F, 1.0F);
    ...
    public Explosion createExplosion(Entity p_217385_1_, double p_217385_2_, double p_217385_4_, double p_217385_6_, float p_217385_8_, Explosion.Mode p_217385_9_) {
    ...
    public Explosion createExplosion(Entity p_217398_1_, double p_217398_2_, double p_217398_4_, double p_217398_6_, float p_217398_8_, boolean p_217398_9_, Explosion.Mode p_217398_10_) {
    ...
    public Explosion createExplosion(Entity p_217401_1_, DamageSource p_217401_2_, double p_217401_3_, double p_217401_5_, double p_217401_7_, float p_217401_9_, boolean p_217401_10_, Explosion.Mode p_217401_11_) {
    ...
    public boolean extinguishFire(PlayerEntity player, BlockPos pos, Direction side) {
        pos = pos.offset(side);
    ...
    public <T extends Entity> List<T> func_225316_b(Class<? extends T> p_225316_1_, AxisAlignedBB p_225316_2_, Predicate<? super T> p_225316_3_) {
    ...
    @OnlyIn(Dist.CLIENT)
    public void makeFireworks(double x, double y, double z, double motionX, double motionY, double motionZ, CompoundNBT compound) {
    }
