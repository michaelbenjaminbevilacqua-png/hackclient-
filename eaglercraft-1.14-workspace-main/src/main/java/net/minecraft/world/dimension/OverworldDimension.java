...
public class OverworldDimension extends Dimension {
   ...
   public ChunkGenerator<? extends GenerationSettings> createChunkGenerator() {
      ...
      if (worldtype == WorldType.FLAT) {
         ...
         JsonElement jsonelement = Dynamic.convert(NBTDynamicOps.INSTANCE, (com.mojang.datafixers.types.DynamicOps<JsonElement>) JsonOps.INSTANCE, this.world.getWorldInfo().getGeneratorOptions());
