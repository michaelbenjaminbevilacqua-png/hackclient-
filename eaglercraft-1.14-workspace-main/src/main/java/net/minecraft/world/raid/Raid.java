...
public class Raid {
    ...
    private final Set<EaglercraftUUID> heroes = Sets.newHashSet();
    ...
    public Raid(ServerWorld p_i50145_1_, CompoundNBT p_i50145_2_) {
        ...
        if (p_i50145_2_.contains("HeroesOfTheVillage", 9)) {
            ...
            for (int i = 0; i < listnbt.size(); ++i) {
                ...
                EaglercraftUUID uuid = compoundnbt.getUniqueId("EaglercraftUUID");
            ...
            if (this.status == Raid.Status.ONGOING) {
                ...
                if (this.func_221301_k() && !this.func_221289_z() && i == 0) {
                    if (this.postRaidTicks < 40) {
                        ...
                        for (EaglercraftUUID uuid : this.heroes) {
    ...
    public void func_221317_a(int wave, AbstractRaiderEntity p_221317_2_, BlockPos p_221317_3_, boolean p_221317_4_) {
    ...
    public CompoundNBT write(CompoundNBT p_221326_1_) {
        ...
        for (EaglercraftUUID uuid : this.heroes) {
            ...
            compoundnbt.putUniqueId("EaglercraftUUID", uuid);
