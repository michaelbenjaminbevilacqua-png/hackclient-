...
public class ChunkManager extends net.lax1dude.eaglercraft.sp.server.EaglerChunkLoader implements ChunkHolder.IPlayerProvider {
    ...
    private final VFile2 field_219270_x;
    ...
    private final Queue<Runnable> saveTasks = new java.util.LinkedList<>();
    private int viewDistance;

    public ChunkManager(ServerWorld p_i51538_1_, VFile2 p_i51538_2_, DataFixer p_i51538_3_, TemplateManager p_i51538_4_, Executor p_i51538_5_, ThreadTaskExecutor<Runnable> p_i51538_6_, IChunkLightProvider p_i51538_7_, ChunkGenerator<?> p_i51538_8_, IChunkStatusListener p_i51538_9_, Supplier<DimensionSavedDataManager> p_i51538_10_, int p_i51538_11_) {
        super(new net.lax1dude.eaglercraft.internal.vfs2.VFile2(p_i51538_1_.getDimension().getType().getDirectory(p_i51538_2_), "region"), p_i51538_3_);
        ...
        this.field_219260_n = new PointOfInterestManager(new VFile2(this.field_219270_x, "poi"), p_i51538_3_);
                ...
                if (p_219237_2_ instanceof ChunkPrimerWrapper) {
                    ...
                    for (ChunkSection chunksection : chunk.getSections()) {
                        if (chunksection != Chunk.EMPTY_SECTION) {
                            this.field_219260_n.func_219139_a(chunkpos, chunksection);
                        }
                    }
                }
