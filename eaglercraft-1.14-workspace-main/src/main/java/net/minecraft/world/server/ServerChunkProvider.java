...
public class ServerChunkProvider extends AbstractChunkProvider {
    ...
    public ServerChunkProvider(ServerWorld worldIn, VFile2 worldDirectory, DataFixer dataFixer, TemplateManager p_i51537_4_, Executor p_i51537_5_, ChunkGenerator<?> chunkGeneratorIn, int viewDistance, IChunkStatusListener p_i51537_8_, Supplier<DimensionSavedDataManager> p_i51537_9_) {
        this.world = worldIn;
    ...
    private boolean func_217224_a(ChunkHolder p_217224_1_, int p_217224_2_) {
