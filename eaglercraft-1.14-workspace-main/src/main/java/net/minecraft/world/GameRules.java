...
public class GameRules {
    ...
    private final Map<GameRules.RuleKey<?>, GameRules.RuleValue<?>> rules = GAME_RULES.entrySet().stream().collect(Collectors.toMap(Entry::getKey, (p_223593_0_) -> {
    ...
    public void read(CompoundNBT nbt) {
        this.rules.forEach((p_223591_1_, p_223591_2_) -> {
            if (nbt.contains(p_223591_1_.field_223578_a)) {
    ...
    public static class BooleanValue extends GameRules.RuleValue<GameRules.BooleanValue> {
        ...
        public void set(boolean p_223570_1_, MinecraftServer p_223570_2_) {
    ...
    public abstract static class RuleValue<T extends GameRules.RuleValue<T>> {
        ...
        protected void func_223556_a(MinecraftServer p_223556_1_) {
            if (p_223556_1_ != null) {
