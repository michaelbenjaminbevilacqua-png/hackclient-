...
public class ChunkSerializer {
   ...
   public static ChunkStatus.Type getChunkStatus( CompoundNBT chunkNBT) {
      if (chunkNBT != null) {
   ...
   private static Map<String, StructureStart> readStructureStarts(ChunkGenerator<?> p_222653_0_, TemplateManager p_222653_1_, BiomeProvider p_222653_2_, CompoundNBT compound) {
      ...
      for(String s : compoundnbt.keySet()) {
         StructureStart structurestart = Structures.func_215142_a(p_222653_0_, p_222653_1_, p_222653_2_, compoundnbt.getCompound(s));
         if (structurestart != null) {
            map.put(s, structurestart);
         }
      }
