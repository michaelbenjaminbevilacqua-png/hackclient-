...
public class LayerUtil {
   ...
   public static <T extends IArea, C extends IExtendedNoiseRandom<T>> ImmutableList<IAreaFactory<T>> buildOverworldProcedure(WorldType worldTypeIn, OverworldGenSettings settings, LongFunction<C> contextFactory) {
      ...
      IAreaFactory<T> lvt_8_1_ = (new BiomeLayer(worldTypeIn, settings)).apply(contextFactory.apply(200L), iareafactory);
      lvt_8_1_ = AddBambooForestLayer.INSTANCE.apply((IExtendedNoiseRandom)contextFactory.apply(1001L), lvt_8_1_);
      lvt_8_1_ = repeat(1000L, ZoomLayer.NORMAL, lvt_8_1_, 2, contextFactory);
      lvt_8_1_ = EdgeBiomeLayer.INSTANCE.apply((IExtendedNoiseRandom)contextFactory.apply(1000L), lvt_8_1_);
