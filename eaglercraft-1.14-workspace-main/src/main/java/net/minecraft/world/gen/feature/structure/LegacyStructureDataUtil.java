...
public class LegacyStructureDataUtil {
   ...
   public LegacyStructureDataUtil( DimensionSavedDataManager p_i51349_1_, List<String> p_i51349_2_, List<String> p_i51349_3_) {
   ...
   private void func_212184_a( DimensionSavedDataManager p_212184_1_) {
      if (p_212184_1_ != null) {
         for(String s : this.field_215132_f) {
   ...
   public static LegacyStructureDataUtil func_215130_a(DimensionType p_215130_0_,  DimensionSavedDataManager p_215130_1_) {
