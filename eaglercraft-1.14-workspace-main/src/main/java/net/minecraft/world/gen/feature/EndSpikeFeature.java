...
public class EndSpikeFeature extends Feature<EndSpikeFeatureConfig> {
   private static final LoadingCache<Long, List<EndSpikeFeature.EndSpike>> field_214555_a = new LoadingCache<>(new EndSpikeFeature.EndSpikeCacheProvider());
   ...
   public static List<EndSpikeFeature.EndSpike> func_214554_a(IWorld p_214554_0_) {
      java.util.Random random = new java.util.Random(p_214554_0_.getSeed());
   ...
   static class EndSpikeCacheProvider implements CacheProvider<Long, List<EndSpikeFeature.EndSpike>> {
      private EndSpikeCacheProvider() {
      }

      public List<EndSpikeFeature.EndSpike> create(Long p_load_1_) {
         List<Integer> list = IntStream.range(0, 10).boxed().collect(Collectors.toList());
         Collections.shuffle(list, new java.util.Random(p_load_1_));
