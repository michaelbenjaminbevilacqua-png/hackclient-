         ...
         for(BlockPos blockpos : BlockPos.getAllInBoxMutable(pos.add((double)(-f), -1.0D, (double)(-f)), pos.add((double)f, -1.0D, (double)f))) {
            if (blockpos.withinDistance(living.getPositionVec(), (double)f)) {
               ...
               if (blockstate1.isAir()) {
                  ...
                  if (blockstate2.getMaterial() == Material.WATER && blockstate2.get(FlowingFluidBlock.LEVEL) == 0 && blockstate.isValidPosition(worldIn, blockpos) && worldIn.func_217350_a(blockstate, blockpos, ISelectionContext.dummy())) {
