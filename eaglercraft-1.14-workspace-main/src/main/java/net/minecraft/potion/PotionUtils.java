...
public class PotionUtils {
    ...
    public static void addCustomPotionEffectToList(CompoundNBT tag, List<EffectInstance> effectList) {
    ...
    public static Potion getPotionTypeFromNBT(CompoundNBT tag) {
