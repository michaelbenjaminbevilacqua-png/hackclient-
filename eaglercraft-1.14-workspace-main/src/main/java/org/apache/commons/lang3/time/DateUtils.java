...
/**
 * <p>
 * A suite of utilities surrounding the use of the {@link Calendar}
 * and {@link Date} object.
 * </p>
 *
 * <p>
...
public class DateUtils {
     ...
     *                      {@code null}, the system locale is used (as per
     ...
     *
     * @param str           the date to parse, not null
     * @param locale        the locale to use when interpreting the pattern, can be
     *                      null in which case the default system locale is used
     * @param parsePatterns the date format patterns to use, see SimpleDateFormat,
     *                      not null
    ...
    /**
     * Sets the specified field to a date returning a new object. This does not use
     * a lenient calendar. The original {@code Date} is unchanged.
     *
     * @param date          the date, not null
     ...
     *
     * <p>
     * For example, if you had the date-time of 28 Mar 2002 13:45:01.231, if this
     ...
     *
     * <p>
     * For a date in a time zone that handles the change to daylight saving time,
...
// ----------------- Fix for LANG-440 ---------------------- END ---------------
    ...
    /**
     * <p>
     * Constructs an {@code Iterator} over each day in a date range defined by a
     * focus date and range style.
     * </p>
     *
     * <p>
     * For instance, passing Thursday, July 4, 2002 and a {@code RANGE_MONTH_SUNDAY}
     * will return an {@code Iterator} that starts with Sunday, June 30, 2002 and
     * ends with Saturday, August 3, 2002, returning a Calendar instance for each
     * intermediate day.
     * </p>
     *
     * <p>
     ...
     * @throws IllegalArgumentException if the date is {@code null} or fragment is
     *                                  not supported
     * @since 2.4
     */
     ...
     * @param cal2  the second calendar, not {@code null}
     * @param field the field from {@code Calendar}
     * @return a negative integer, zero, or a positive integer as the first calendar
     ...
     * @param date2 the second date, not {@code null}
     * @param field the field from {@code Calendar}
     * @return a negative integer, zero, or a positive integer as the first date is
