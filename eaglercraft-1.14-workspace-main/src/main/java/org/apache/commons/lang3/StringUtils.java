 ...
 * <li><b>startsWith</b> - check if a String starts with a prefix in a null-safe
 * manner</li>
 * <li><b>endsWith</b> - check if a String ends with a suffix in a null-safe
 * manner</li>
 * <li><b>IndexOf/LastIndexOf/Contains</b> - null-safe index-of checks
 * <li><b>IndexOfAny/LastIndexOfAny/IndexOfAnyBut/LastIndexOfAnyBut</b> -
 * index-of any of a set of Strings</li>
 * <li><b>ContainsOnly/ContainsNone/ContainsAny</b> - checks if String contains
 ...
 * <li><b>Abbreviate</b> - abbreviates a string using ellipses or another given
 * String</li>
...
public class StringUtils {
    ...
    /**
     * <p>
     * Checks if the CharSequence contains any of the CharSequences in the given
     * array.
     * </p>
     *
     * <p>
    ...
    /**
     * <p>
     * Check if a CharSequence ends with any of the provided case-sensitive
     * suffixes.
     * </p>
     *
     * <pre>
     ...
     * to any of the {@code searchStrings}.
     * </p>
     *
     * <pre>
     ...
     * @param charset The {@link Charset} to encode the {@code String}. If null,
    ...
    public static byte[] getBytes(final String string, final Charset charset) {
        return string == null ? new byte[0] : string.getBytes(Charsets.toCharset(charset));
    }
     ...
     *
     * @param string  input string
     * @param charset The {@link Charset} name to encode the {@code String}. If
    ...
    public static byte[] getBytes(final String string, final String charset) throws UnsupportedEncodingException {
        return string == null ? new byte[0] : string.getBytes(Charsets.toCharsetName(charset));
    }
     ...
     * <p>
     * Returns either the passed in CharSequence, or if the CharSequence is
     * whitespace, empty ("") or {@code null}, the value supplied by
     * {@code defaultStrSupplier}.
     * </p>
     *
     * <p>
     * Whitespace is defined by {@link Character#isWhitespace(char)}.
     ...
     *                        input is whitespace, empty ("") or {@code null}, may
     *                        be null
     * @return the passed in CharSequence, or the default
     * @see StringUtils#defaultString(String, String)
     * @since 3.10
     ...
     * represented by the {@code seq} {@code CharSequence} object at an index no
     ...
     * {@code CharSequence} object is searched backwards starting at the last
     * character.
     *
     * <pre>
     * StringUtils.lastIndexOf(null, *)         = -1
     ...
     * return {@code -1}. A start position greater than the string length searches
     * the whole string. The search starts at the {@code startPos} and works
     * backwards; matches starting after the start position are ignored.
     *
     * <p>
     * All indices are specified in {@code char} values (Unicode code units).
     ...
     * incrementing the starting index by one after each successful match (unless
     * {@code searchStr} is an empty string in which case the position is never
     * incremented and {@code 0} is returned immediately). This means that matches
     * may overlap.
     * </p>
     * <p>
     * A {@code null} CharSequence will return {@code -1}.
     ...
     * <p>
     * Replaces a String with another String inside a larger String, for the first
     * {@code max} values of the search String, case sensitively/insensitively based
    ...
    private static String replaceEach(final String text, final String[] searchList, final String[] replacementList,
        ...
        if (isEmpty(text) || searchList.length == 0 || replacementList.length == 0
                || (searchList.length > 0 && timeToLive == -1)) {
            return text;
        }
