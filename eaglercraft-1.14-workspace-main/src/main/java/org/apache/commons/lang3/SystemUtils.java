...
public class SystemUtils {
     ...
     * </p>
     * <p>
     * Defaults to {@code null} if the runtime does not have security access to read
     ...
     * {@link System#setProperties(java.util.Properties)} is called after this class
     * is loaded, the value will be out of sync with that System property.
     * </p>
     *
     * @since 2.1
     */
     ...
     *
     * @since Java 1.1
     * @deprecated Use {@link File#separator}, since it is guaranteed to be a string
     * containing a single character and it does not require a privilege
     * check.
     */
    @Deprecated
    ...
    /**
     * <p>
     * The {@code java.awt.headless} System Property. The value of this property is
     * the String {@code "true"} or {@code "false"}.
     * </p>
     * <p>
     * Defaults to {@code null} if the runtime does not have security access to read
     * this property or the property does not exist.
    ...
    /**
     * <p>
     * The {@code java.compiler} System Property. Name of JIT compiler to use. First
     * in JDK version 1.2. Not used in Sun JDKs after 1.2.
     * </p>
     * <p>
     * Defaults to {@code null} if the runtime does not have security access to read
     * this property or the property does not exist.
    ...
    /**
     * <p>
     * The {@code java.endorsed.dirs} System Property. Path of endorsed directory or
     * directories.
     * </p>
     * <p>
     * Defaults to {@code null} if the runtime does not have security access to read
    ...
    /**
     * <p>
     * The {@code java.library.path} System Property. List of paths to search when
     * loading libraries.
     * </p>
     * <p>
     * Defaults to {@code null} if the runtime does not have security access to read
    ...
    /**
     * <p>
     * The {@code java.runtime.version} System Property. Java Runtime Environment
     * version.
     * </p>
     * <p>
     * Defaults to {@code null} if the runtime does not have security access to read
    ...
    /**
     * <p>
     * The {@code java.specification.name} System Property. Java Runtime Environment
     * specification name.
     * </p>
     * <p>
     * Defaults to {@code null} if the runtime does not have security access to read
    ...
    /**
     * <p>
     * The {@code java.vm.info} System Property. Java Virtual Machine implementation
     * info.
     * </p>
     * <p>
     * Defaults to {@code null} if the runtime does not have security access to read
    ...
    /**
     * <p>
     * The {@code java.vm.name} System Property. Java Virtual Machine implementation
     * name.
     * </p>
     * <p>
     * Defaults to {@code null} if the runtime does not have security access to read
    ...
    /**
     * <p>
     * The {@code java.vm.specification.name} System Property. Java Virtual Machine
     * specification name.
     * </p>
     * <p>
     * Defaults to {@code null} if the runtime does not have security access to read
     ...
     * string containing a single character and it does not require a
     * privilege check.
     */
    @Deprecated
    ...
    /**
     * <p>
     * Is {@code true} if this is a UNIX like system, as in any of AIX, HP-UX, Irix,
     ...
     * @return the environment variable value or {@code defaultValue} if a security
     * problem occurs
     * @since 3.8
     */
    public static String getEnvironmentVariable(final String name, final String defaultValue) {
        try {
            ...
            // System.err.println("Caught a SecurityException reading the environment
            // variable '" + name + "'.");
            return defaultValue;
        }
    }
     ...
     *
     * <p>
     * If you want to know what the network stack says is the host name, you should
     * use {@code InetAddress.getLocalHost().getHostName()}.
     * </p>
     *
     * @return the host name. Will be {@code null} if the environment variable is
     * not defined.
     * @since 3.6
     */
    ...
    /**
     * <p>
     * Gets a System property, defaulting to {@code null} if the property cannot be
     * read.
     * </p>
     * <p>
     * If a {@code SecurityException} is caught, the return value is {@code null}
     * and a message is written to {@code System.err}.
     * </p>
     *
     ...
     *
     * @param requiredVersion the required version, for example 1.31f
     * @return {@code true} if the actual version is equal or less than the required
     * version
     * @since 3.9
     */
