...
/**
 * <p>
 * Controls {@code String} formatting for {@link ToStringBuilder}. The main
 * public interface is always via {@code ToStringBuilder}.
 * </p>
 *
 * <p>
 * These classes are intended to be used as {@code Singletons}. There is no need
 * to instantiate a new style each time. A program will generally use one of the
 * predefined constants on this class. Alternatively, the
 ...
 * {@code Object} to {@code int[]}) has its own methods to output it. Most have
 * two versions, detail and summary.
 *
 * <p>
...
public abstract class ToStringStyle implements Serializable {
    ...
    /**
     * The no field names toString style. Using the {@code Person} example from
     * {@link ToStringBuilder}, the output would look like this:
     *
     * <pre>
    ...
    /**
     * The simple toString style. Using the {@code Person} example from
     * {@link ToStringBuilder}, the output would look like this:
     *
     * <pre>
     * John Doe,33,false
     ...
     * name is passed in while appending. Furthermore This ToStringStyle will only
    ...
    /**
     * <p>
     * A registry of objects used by {@code reflectionToString} methods to detect
     * cyclical object references and avoid infinite loops.
     * </p>
     */
    private static final ThreadLocal<HashMap<Object, Object>> REGISTRY = new ThreadLocal<>();
    /*
     * Note that objects of this class are generally shared between threads, so an
     * instance variable would not be suitable here.
     *
     ...
     * {@code reflectionToString} methods in the current thread.
     * </p>
     *
    ...
    /**
     * <p>
     * Returns {@code true} if the registry contains the given object. Used by the
    ...
    /**
     * <p>
     * Append to the {@code toString} an {@code Object}, correctly interpreting its
     * type.
     * </p>
     *
     * <p>
     * This method performs the main lookup by Class type to correctly route arrays,
     * {@code Collections}, {@code Maps} and {@code Objects} to the appropriate
     * method.
     * </p>
     *
     * <p>
    ...
    /**
     * <p>
     * Append to the {@code toString} an {@code Object} value that has been detected
     * to participate in a cycle. This implementation will print the standard string
     * value of the value.
     * </p>
     *
     * @param buffer    the {@code StringBuffer} to populate
     ...
     * @param buffer    the {@code StringBuffer} to populate
     * @param fieldName the field name, typically not used as already appended
     * @param coll      the {@code Collection} to add to the {@code toString}, not
     *                  {@code null}
     */
     ...
     * @param buffer    the {@code StringBuffer} to populate
     * @param fieldName the field name, typically not used as already appended
     * @param map       the {@code Map} to add to the {@code toString}, not
     *                  {@code null}
     */
    ...
    /**
     * <p>
     * Append to the {@code toString} an {@code Object} value, printing a summary of
     * the {@code Object}.
     * </P>
     *
     * @param buffer    the {@code StringBuffer} to populate
     ...
     *
     * <p>
     * The size summary is used to summarize the contents of {@code Collections},
     * {@code Maps} and arrays.
     * </p>
     *
     * <p>
     ...
     * may request full detail ({@code true}), but a subclass might ignore that and
    ...
    /**
     * <p>
     * Gets the start text to output when a {@code Collection}, {@code Map} or array
     * size is output.
     * </p>
     *
     * <p>
    ...
    /**
     * <p>
     * Sets the start text to output when a {@code Collection}, {@code Map} or array
     * size is output.
     * </p>
     *
     * <p>
     ...
     *
     * <p>
     * This is an inner class rather than using {@code StandardToStringStyle} to
    ...
    /**
     * <p>
     * {@code ToStringStyle} that prints out the short class name and no identity
     * hashcode.
     * </p>
     *
     * <p>
    ...
    /**
     * <p>
     * {@code ToStringStyle} that does not print out the classname, identity
    ...
    /**
     * <p>
     * {@code ToStringStyle} that does not print out the classname and identity hash
     * code but prints content start and field names.
     * </p>
     *
     * <p>
     * This is an inner class rather than using {@code StandardToStringStyle} to
