 ...
 *
 * <p>
 * To obtain a FastDatePrinter, use
 ...
 *
 * <p>
 * Only formatting is supported by this class, but all patterns are compatible
 * with SimpleDateFormat (except time zones and some year patterns - see below).
 * </p>
 *
 * <p>
 ...
 * using one of the {@code 'X'} formats is recommended.
 *
 * <p>
 ...
 * FastDatePrinter implements the behavior of Java 7.
 * </p>
 *
 * @see FastDateParser
 * @since 3.2
...
public class FastDatePrinter implements DatePrinter, Serializable {
    ...
    public StringBuffer format(final Calendar calendar, final StringBuffer buf) {
        // do not pass in calendar directly, this will cause TimeZone of FastDatePrinter
        // to be ignored
     ...
     * @deprecated use {@link #format(Calendar)} or
     * {@link #format(Calendar, Appendable)}
     */
    @Deprecated
    ...
    private <B extends Appendable> B applyRules(final Calendar calendar, final B buf) {
        try {
            ...
            throw new RuntimeException("Unexpected throwable", ioe);
        }
        return buf;
    }
    ...
    private interface Rule {
        ...
        /**
         * Appends the value of the specified calendar to the output buffer based on the
         * rule implementation.
         *
    ...
    private static class CharacterLiteral implements Rule {
        ...
        /**
         * Constructs a new instance of {@code CharacterLiteral} to hold the specified
         * value.
         *
    ...
    private static class StringLiteral implements Rule {
        ...
        /**
         * Constructs a new instance of {@code StringLiteral} to hold the specified
         * value.
         *
    ...
    private static class TextField implements Rule {
        ...
        /**
         * Constructs an instance of {@code TextField} with the specified field and
         * values.
         *
    ...
    private static class UnpaddedNumberField implements NumberRule {
        ...
        /**
         * Constructs an instance of {@code UnpadedNumberField} with the specified
         * field.
         *
         * @param field the field
         */
    ...
    private static class TwoDigitNumberField implements NumberRule {
        ...
        /**
         * Constructs an instance of {@code TwoDigitNumberField} with the specified
         * field.
         *
         * @param field the field
         */
    ...
    private static final Map<TimeZoneDisplayKey, String> cTimeZoneDisplayCache = new HashMap<>(7);
    ...
    private static class TimeZoneNumberRule implements Rule {
        ...
        /**
         * Constructs an instance of {@code TimeZoneNumberRule} with the specified
         * properties.
         *
    ...
    private static class Iso8601_Rule implements Rule {
         ...
         * {@code tokenLen}. If no such rule exists, an IllegalArgumentException
         * will be thrown.
         */
    ...
    private static class TimeZoneDisplayKey {
        ...
        /**
         * Constructs an instance of {@code TimeZoneDisplayKey} with the specified
         * properties.
         *
         * @param timeZone the time zone
