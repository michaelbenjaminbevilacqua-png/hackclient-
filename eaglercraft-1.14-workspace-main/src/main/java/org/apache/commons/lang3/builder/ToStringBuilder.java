 ...
 *
 * <p>
 * This class enables a good and consistent {@code toString()} to be built for
 ...
 *
 * <p>
 * To add the superclass {@code toString}, use {@link #appendSuper}. To append
 * the {@code toString} from an object that is delegated to (or any other
 * object), use {@link #appendToString}.
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The exact format of the {@code toString} is determined by the
...
public class ToStringBuilder implements Builder<String> {
     ...
     * startup. It is recommended to pass a {@code ToStringStyle} to the constructor
     * instead of using this global default.
     * </p>
     *
     * <p>
     * This method can be used from multiple threads. Internally, a {@code volatile}
     * variable is used to provide the guarantee that the latest value set using
     * {@link #setDefaultStyle} is the value returned. It is strongly recommended
     * that the default style is only changed during application startup.
     * </p>
     *
     * <p>
     ...
     * Changing this default should generally only be done during application
     * startup. It is recommended to pass a {@code ToStringStyle} to the constructor
     * instead of changing this global default.
     * </p>
     *
     * <p>
     * This method is not intended for use from multiple threads. Internally, a
     * {@code volatile} variable is used to provide the guarantee that the latest
     * value set is the value returned from {@link #getDefaultStyle}.
     * </p>
     *
     ...
     * </p>
     *
     * @param object the Object to build a {@code toString} for, not recommended to
     *               be null
     */
     ...
     * @param object the Object to build a {@code toString} for, not recommended to
     *               be null
     * @param style  the style of the {@code toString} to create, null uses the
     *               default style
     */
     ...
     * {@code true} will output the array in full. Setting {@code false} will output
     * a summary, typically the size of the array.
     * </p>
     *
     * @param fieldName  the field name
     * @param array      the array to add to the {@code toString}
     ...
     * its properties to another class. You can then call {@code toString()} on the
     * other class and pass the result into this method.
     * </p>
     *
     * <pre>
