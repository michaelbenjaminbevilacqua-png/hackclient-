...
import net.minecraft.client.renderer.vertex.DVF;

import java.util.ArrayList;
import java.util.List;

import static net.lax1dude.eaglercraft.opengl.GlStateManager.*;
...
//			break;
    ...
    public static void glBegin(int mode) {
        ...
        if (mode == GL_POLYGON) {
            ...
            worldRenderer.begin(mode, DVF.POSITION);
        }
    ...
    public static void glEnd() {
        ...
        if (isPolygonMode) {
            ...
            worldRenderer.begin(GL_TRIANGLES, DVF.POSITION);
    ...
    public static int glGenLists(int count) {
        ...
        int base = EaglercraftGPU.glGenLists();
        for (int i = 1; i < count; i++) {
            EaglercraftGPU.glGenLists();
        }
        return base;
    }
    ...
    public static void glTexImage2D(int target, int level, int internalFormat, int w, int h, int unused, int format, int type, IntBuffer pixels) {
        EaglercraftGPU.glTexImage2D(target, level, internalFormat, w, h, unused, format, type, pixels);
    }
